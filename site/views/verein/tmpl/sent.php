...
if ($new < 1) {
	...
	if(is_null($lokal_coord)||$lokal_coord == -1){
		...
		{
			$mainframe->enqueueMessage( Text::_( 'CLUB_DATA_GEO_WARNING' ), 'warning' );
		}
	}
	else{
...
// Log
	...
	$msg = Text::_( 'CLUB_DATA_SENT_SAVED' );
//	$mainframe->enqueueMessage( $msg );
...
// Mailbody HTML Header
	$body_html_header = '
			...
			<title>'.Text::_( 'CLUB_DATA_MAIL_HEADLINE' ).'</title>
			</head>
			<body>';
	$body_html_footer = '
			</body>
...
// Mailbody HTML Vereinsdatenpflege im FE
	$body_html =	'
		...
		<tr>
			<td bgcolor="#F2F2F2" style="border-bottom: solid 1px #000000; border-top: solid 1px #000000; padding: 3px;" colspan="7"><div align="center" style="font-size: 12px;"><strong>'.Text::_( 'CLUB_DATA_MAIL_HEADLINE' ).' '.Text::_( 'OF_DAY' ).HTMLHelper::_('date', $now, Text::_('DATE_FORMAT_CLM_PDF')). '</strong></div></td>
		</tr>
		<tr>
			<td width="120">&nbsp;</td>
			<td>&nbsp;</td>
	...
	$body_html .=	'
		<table width="700" border="0" cellspacing="0" cellpadding="3" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 11px;">
		<tr>
			<td width="100" bgcolor="#F2F2F2" style="border-bottom: solid 1px #000000; border-top: solid 1px #000000; padding: 3px;"><div align="center" style="font-size: 12px;"><strong>'.Text::_( 'CLUB_DATA_LOCATION' ).'</strong></div></td>
		...
		<tr>
			<td width="100" bgcolor="#F2F2F2" style="border-bottom: solid 1px #000000; border-top: solid 1px #000000; padding: 3px;"><div align="center" style="font-size: 12px;"><strong>'.Text::_( 'CLUB_DATA_ADRESS' ).'</strong></div></td>
			<td width="400" nowrap="nowrap" valign="top" size="1" colspan="7">
				<textarea cols="30" rows="2" style="border: solid 1px #999999; width:90%">'.str_replace('&','&amp;',$verein[0]->adresse).'</textarea>
			</td>
		</tr>
		<tr>
			<td width="100" bgcolor="#F2F2F2" style="border-bottom: solid 1px #000000; border-top: solid 1px #000000; padding: 3px;"><div align="center" style="font-size: 12px;"><strong>'.Text::_( 'CLUB_DATA_DATE' ).'</strong></div></td>
			<td width="400" nowrap="nowrap" valign="top" size="1" colspan="7">
				<textarea cols="30" rows="2" style="border: solid 1px #999999; width:90%">'.str_replace('&','&amp;',$verein[0]->termine).'</textarea>
			</td>
		</tr>
		<tr>
			<td width="100" bgcolor="#F2F2F2" style="border-bottom: solid 1px #000000; border-top: solid 1px #000000; padding: 3px;"><div align="center" style="font-size: 12px;"><strong>'.Text::_( 'CLUB_DATA_HOMEPAGE' ).'</strong></div></td>
			<td width="400" nowrap="nowrap" valign="top" size="1" colspan="7">
...
// Mailbody HTML Vereinsdatenpflege im FE
	$body_html .=	'
		...
		<tr>
			<td width="120" style="border-bottom: solid 1px #999999;"><strong>'.Text::_( 'CLUB_DATA_CHIEF' ).'</strong></td>
		...
		<tr>
			<td width="120" style="border-bottom: solid 1px #999999;"><strong>'.Text::_( 'CLUB_DATA_TOURNAMENT' ).'</strong></td>
		...
		<tr>
			<td width="120" style="border-bottom: solid 1px #999999;"><strong>'.Text::_( 'CLUB_DATA_YOUTH' ).'</strong></td>
		...
		<tr>
			<td width="120" style="border-bottom: solid 1px #999999;"><strong>'.Text::_( 'CLUB_DATA_PRESS' ).'</strong></td>
		...
		<tr>
			<td width="120" style="border-bottom: solid 1px #999999;"><strong>'.Text::_( 'CLUB_DATA_MONEY' ).'</strong></td>
		...
		<tr>
			<td width="120" style="border-bottom: solid 1px #999999;"><strong>'.Text::_( 'CLUB_DATA_SENIOR' ).'</strong></td>
	...
	$subject = $fromname.': '.Text::_('CLUB_DATA_SUBJECT').' '.$verein[0]->name.'  -  '.Text::_( 'CLUB_LIST_MAIL_SEASON' ).'  '.$saison[0]->name;
	$countmail = 0;
	...
	if (isset($melder[0]->email) AND clm_core::$load->is_email($melder[0]->email)) {
		...
		<tr>
		  <td>'.Text::_('CLUB_DATA_MAIL_MD1').'</td>
  		</tr>
		<tr>
		  <td>'.Text::_('CLUB_DATA_MAIL_MD2').'</td>
  		</tr>
		<tr>
		  <td>'.Text::_('CLUB_DATA_MAIL_MD3').'</td>
		</tr>
		</table>';
	...
	foreach ($staffelleiter as $staffelleiter1) { 
	  if ($sl_mail == 1 AND isset($staffelleiter1->sl_email) AND clm_core::$load->is_email($staffelleiter1->sl_email)) {
		...
		if (!in_array($recipient, $a_sl)) {
			...
			<table width="700" border="0" cellspacing="0" cellpadding="3" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px;">
			<tr>
			<td>'.Text::_('CLUB_DATA_MAIL_SL1').'</td>
			</tr>
			<tr>
			<td>'.Text::_('CLUB_DATA_MAIL_SL2').'</td>
			</tr>
			<tr>
			<td>'.Text::_('CLUB_DATA_MAIL_SL3').'</td>
			</tr>
			</table>';
