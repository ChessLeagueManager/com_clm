...
// Turnier Registration nicht gesetzt oder abgelaufen - Tournament registration not chosen or expired
	...
	echo CLMContent::componentheading($heading);
	echo CLMContent::clmWarning(Text::_('TOURNAMENT_NO_ONLINE_REG'));
...
// Turnier - Tournament
	...
	// Online Anmeldung - Online Registration
		...
		if ($typeRegistration < 5) { 
			$headline = Text::_('REGISTRATION_ONLINE');
			$layout = 'sent';
			$button = Text::_('CLUB_DATA_SEND_BUTTON');
		} else {
			$headline = Text::_('REGISTRATION_ONLINE_5');
			$layout = 'selection';
			$button = 'Weiter';
		}
		?>
	...
	<script language="javascript" type="text/javascript">
	  ...
	  <form action="index.php?option=com_clm&amp;view=turnier_registration&amp;layout=selection" method="post" name="adminForm" id="adminForm">
		...
		<tr>
			<td align="left" width="100"><?php echo Text::_('REGISTRATION_PLAYER'); ?>(*):</td>
			<td colspan="3">
		...
		<tr>
			<td align="left" width="100"><?php echo Text::_('REGISTRATION_VORNAME'); ?>(*):</td>
			<td colspan="3">
		...
		<tr>
			<td align="left" width="100"><?php echo Text::_('REGISTRATION_JAHR'); ?>(*):</td>
			<td colspan="3">
		...
		<tr>
			<td align="left" width="100"><?php echo Text::_('REGISTRATION_MAIL'); ?>(*):</td>
			<td colspan="3">
			<input class="inputbox" type="text" name="reg_mail" id="reg_mail" size="50" maxlength="100" value="<?php echo $reg_mail; ?>" />
			</td>
		</tr>
		<tr>
			<td align="left" width="100"><?php echo Text::_('REGISTRATION_TEL_NO'); ?>:</td>
			<td colspan="3">
	...
	?>
		<tr>
			<td align="left" width="100" title="<?php echo Text::_('REGISTRATION_ACCOUNT_HINT'); ?>"><?php echo Text::_('REGISTRATION_ACCOUNT_'.$typeAccount); ?>(*):</td>
			<td colspan="3">
	...
	?>
		<tr>
			<td align="left" width="100"><?php echo Text::_('REGISTRATION_CLUB'); ?>(*):</td>
			<td colspan="3">
		...
		<tr>
			<td align="left" width="100"><?php echo Text::_('REGISTRATION_ZPS'); ?>(**):</td>
			<td width="40%">
			<input class="inputbox" type="text" name="reg_zps" id="reg_zps" size="5" maxlength="5" value="<?php echo $reg_zps; ?>" />
			</td>
			<td align="left" width="100"><?php echo Text::_('REGISTRATION_MGLNR'); ?>(**):</td>
			<td>
		...
		<tr>
			<td align="left" width="100"><?php echo Text::_('REGISTRATION_DWZ'); ?>:</td>
			<td width="40%">
			<input class="inputbox" type="text" name="reg_dwz" id="reg_dwz" size="4" maxlength="4" value="<?php echo $reg_dwz; ?>" />
			</td>
			<td align="left" width="100"><?php echo Text::_('REGISTRATION_ELO'); ?>:</td>
			<td>
		...
		<?php } ?>
		<tr>
			<td align="left" width="100"><?php echo Text::_('REGISTRATION_SEX'); ?>:</td>
		...
		<tr>
			<td align="left" width="100"><?php echo Text::_('REGISTRATION_COMMENT'); ?>:</td>
			<td colspan="3">
			<textarea class="inputbox" name="reg_comment" id="reg_comment" cols="50" rows="4" placeholder="<?php echo Text::_('REGISTRATION_PLACEHOLDER'); ?>"><?php echo $reg_comment; ?></textarea>
			</td>
		</tr>
	<?php } else {
		  } 
		...
		<?php if ($privacy_notice != '') { ?>
		  <tr>
			...
			<th align="left" colspan="3" class="anfang">
				...
				<span style="font-size: 80%; font-weight: lighter;"><?php echo Text::_('REGISTRATION_COMMENT_3'); ?></span>
			</th>
		  </tr>
		<?php } ?>
		<tr>
			<td align="left" width="100"><?php echo Text::_('REGISTRATION_CHECK'); ?>(*):</td>
		...
		<tr>
			<th align="left" colspan="2" class="anfang">
				<span style="font-size: 80%; font-weight: lighter;"><?php echo Text::_('REGISTRATION_COMMENT_1'); ?></span>
			</th>
		</tr>
