...
<div >
<div id="termine">
    <div class="componentheading"><?php echo Text::_('TERMINE_HEAD') ?></div>
    ...
    <?php  } else {  ?>
    	<table>
        	<tr>
            	<td width="200"><?php echo Text::_('TERMINE_TITLE') ?></td>
            	<td><?php echo $termine_detail[0]->name; ?></td>
            </tr>
            <?php if ($termine_detail[0]->hostname <>'') { ?>
        	<tr>
            	<td><?php echo Text::_('TERMINE_HOST') ?></td>
        	...
        	<tr>
            	<td><?php echo Text::_('TERMINE_ADRESS') ?></td>
            	<td><?php echo $termine_detail[0]->address; ?></td>
            </tr>
            <?php } if ($termine_detail[0]->event_link <>'') { ?>
        	<tr>
            	<td><?php echo Text::_('TERMINE_EVENT_LINK') ?></td>
            	<td><a href="<?php echo $termine_detail[0]->event_link; ?>"><?php echo $termine_detail[0]->event_link; ?></a></td>
            </tr>
            <?php } if ($termine_detail[0]->category <> '') { ?>
        	<tr>
            	<td><?php echo Text::_('TERMINE_KATEGORIE') ?></td>
            	<td><?php echo $termine_detail[0]->category; ?></td>
            </tr>
            <?php } ?>
        	<tr>
            	<td><?php echo Text::_('TERMINE_DATUM') ?></td>
            	<td>
					<?php  echo $arrWochentag[date("l",$startdate[0])]. ",&nbsp;". HTMLHelper::_( 'date', $termine_detail[0]->startdate, Text::_('DATE_FORMAT_CLM'));
					...
					if ($termine_detail[0]->enddate != 0) { 
						...
						if ($termine_detail[0]->enddate != $termine_detail[0]->startdate) echo $arrWochentag[date("l",$enddate[0])]. ",&nbsp;". HTMLHelper::_( 'date', $termine_detail[0]->enddate, Text::_('DATE_FORMAT_CLM')).'&nbsp;&nbsp;';  
        ...
        <table>
        	<tr>
            	<td colspan="2"><?php echo Text::_('TERMINE_DESC') ?></td>
            </tr>
        	<tr>
    ...
    <a href="index.php?option=com_clm&amp;view=termine&amp;categoryid=<?php echo $categoryid; ?>&amp;saison=<?php echo $sid; if ($itemid <>'') { echo "&Itemid=". $itemid; } ?>"><?php echo Text::_('TERMINE_BACK') ?></a>
	<br>
	<?php  if ($sreferer === false) { ?>
    <a href="<?php echo $referer; ?>"><?php echo Text::_('TERMINE_BACK_TOTAL') ?></a>
	<?php  } ?>	
    <br>
    <br>
