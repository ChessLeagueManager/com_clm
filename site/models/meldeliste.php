...
//			." WHERE (a.ZPS = '$zps' OR a.ZPS = '$sg_zps') "
            ...
            if ($val == 1) {
                $order = "IFNULL(l.snr,999), a.Spielername ASC";
            } else {
                $order = "IFNULL(l.snr,999), a.DWZ DESC";
            }
    ...
    public function _getCLMAbgabe(&$options)
    {
        $sid	= clm_core::$load->request_int('saison', '1');
        $zps	= clm_escape(clm_core::$load->request_string('zps'));
        $man	= clm_core::$load->request_int('man', '1');
    ...
    public function getCLMAbgabe($options = array())
    {
    ...
    public function _getCLMML(&$options)
    {
        $sid	= clm_core::$load->request_int('saison', '1');
    ...
    public function getCLMML($options = array())
    {
    ...
    public function _getCLMLigen(&$options)
    {
        $sid	= clm_core::$load->request_int('saison', '1');
        $zps 	= clm_escape(clm_core::$load->request_string('zps'));
        $layout	= clm_escape(clm_core::$load->request_string('layout'));
    ...
    public function getCLMLigen($options = array())
    {
