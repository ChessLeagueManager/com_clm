...
class CLMModelInfo extends JModelLegacy
{
    ...
    public function _getCLMWBrett(&$options)
    {
        $sid = CLMModelInfo::CLMSid();
        $ligen = CLMModelInfo::CLMLigen();
    ...
    public function getCLMWBrett($options = array())
    {
    ...
    public function _getCLMSBrett(&$options)
    {
        $sid = CLMModelInfo::CLMSid();
        $ligen = CLMModelInfo::CLMLigen();
    ...
    public function getCLMSBrett($options = array())
    {
