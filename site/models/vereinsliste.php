...
class CLMModelVereinsliste extends JModel
{
	...
	$query = "SELECT DISTINCT b.ZPS, b.Status, a.zps, a.name, a.homepage, a.vs, a.vs_mail, c.*, d.*, "
		...
		." LEFT JOIN dwz_vereine AS c ON c.ZPS = a.zps"
		." LEFT JOIN dwz_verbaende AS d ON d.Verband = c.Verband"
	...
	$query = 'SELECT  a.zps, b.*, c.*'
		." FROM #__clm_vereine AS a"
		." LEFT JOIN dwz_vereine AS b ON b.ZPS = a.zps"
		." LEFT JOIN dwz_verbaende AS c ON c.LV = b.LV"
