...
class CLMModelMeldung extends JModelLegacy
{
    ...
    public function _getCLMCountHeim(&$options)
    {
        $liga	= JRequest::getInt('liga');
        $sid	= JRequest::getInt('saison');
        $runde	= JRequest::getInt('runde');
    ...
    public function getCLMCountHeim($options = array())
    {
    ...
    public function _getCLMHeim(&$options)
    {
        ...
        if ($runde[0]->rang != "0") {
            $sql = $sql.",r.rang ,r.man_nr as rmnr";
        }
        $sql = $sql
        ." FROM #__clm_meldeliste_spieler as a "
    ...
    public function _getCLMCountGast(&$options)
    {
        $liga	= JRequest::getInt('liga');
        $sid	= JRequest::getInt('saison');
        $runde	= JRequest::getInt('runde');
    ...
    public function getCLMCountGast($options = array())
    {
    ...
    // Ergebnis ermitteln
    public function _getCLMErgebnis(&$options)
    {
        $liga	= JRequest::getInt('liga');
        $sid	= JRequest::getInt('saison');
        $runde	= JRequest::getInt('runde');
    ...
    public function getCLMErgebnis($options = array())
    {
    ...
    public function _getCLMAccess(&$options)
    {
    ...
    public function getCLMAccess($options = array())
    {
    ...
    public function _getCLMMeldung(&$options)
    {
        $user	= JFactory::getUser();
        $jid	= $user->get('id');
        $lid 	= JRequest::getInt('liga');
    ...
    public function getCLMMeldung($options = array())
    {
    ...
    public function _getCLMfinish(&$options)
    {
        $lid = JRequest::getInt('liga');
        $sid = JRequest::getInt('saison');
    ...
    public function getCLMfinish($options = array())
    {
    ...
    public function _getCLMoldresult(&$options)
    {
        $lid	= JRequest::getInt('liga');
        $sid	= JRequest::getInt('saison');
        $runde	= JRequest::getInt('runde');
    ...
    public function getCLMoldresult($options = array())
    {
