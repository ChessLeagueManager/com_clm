...
class CLMModelStatistik extends JModelLegacy
{
    ...
    public function getCLMSchwarz($options = array())
    {
    ...
    public function _getCLMRemis(&$options)
    {
        $sid	= clm_core::$load->request_int('saison', 1);
        $lid	= clm_core::$load->request_int('liga', 1);
        $db			= JFactory::getDBO();
    ...
    public function getCLMRemis($options = array())
    {
    ...
    public function _getCLMKampflos(&$options)
    {
        $sid	= clm_core::$load->request_int('saison', 1);
        $lid	= clm_core::$load->request_int('liga', 1);
        $db			= JFactory::getDBO();
    ...
    public function getCLMKampflos($options = array())
    {
    ...
    public function _getCLMHeim(&$options)
    {
        $sid	= clm_core::$load->request_int('saison', 1);
        $lid	= clm_core::$load->request_int('liga', 1);
        $db			= JFactory::getDBO();
    ...
    public function getCLMHeim($options = array())
    {
    ...
    public function _getCLMGast(&$options)
    {
        $sid	= clm_core::$load->request_int('saison', 1);
        $lid	= clm_core::$load->request_int('liga', 1);
        $db			= JFactory::getDBO();
    ...
    public function getCLMGast($options = array())
    {
    ...
    public function _getCLMGesamt(&$options)
    {
        $sid	= clm_core::$load->request_int('saison', 1);
        $lid	= clm_core::$load->request_int('liga', 1);
        $db			= JFactory::getDBO();
    ...
    public function getCLMGesamt($options = array())
    {
    ...
    public function _getCLMBestenliste(&$options)
    {
        ...
        $sort_string = "";
        if (!isset($params['btiebr1']) or $params['btiebr1'] == 0) {
            $sort_string = " g.gpunkte DESC, g.gpartien ASC, a.Leistung DESC, a.Niveau DESC ";
        } else {
            for ($x = 1; $x < 5; $x++) {
                if ($x != 1 and $params['btiebr'.$x] > 0) {
                    $sort_string .= ",";
                }
                //if ($params['btiebr'.$x] == 1) $sort_string .= " g.gpunkte DESC ";
                if ($params['btiebr'.$x] == 1) {
                    $sort_string .= " a.Punkte DESC ";
                }
                //elseif ($params['btiebr'.$x] == 2) $sort_string .= " g.gpartien ASC ";
                elseif ($params['btiebr'.$x] == 2) {
                    $sort_string .= " a.Partien ASC ";
                } elseif ($params['btiebr'.$x] == 3) {
                    $sort_string .= " a.Niveau DESC ";
                } elseif ($params['btiebr'.$x] == 4) {
                    $sort_string .= " a.Leistung DESC ";
                }
                //elseif ($params['btiebr'.$x] == 5) $sort_string .= " gprozent DESC ";
                elseif ($params['btiebr'.$x] == 5) {
                    $sort_string .= " Prozent DESC ";
                } elseif ($params['btiebr'.$x] == 6) {
                    $sort_string .= " e.epunkte DESC ";
                } elseif ($params['btiebr'.$x] == 7) {
                    $sort_string .= " e.epartien ASC ";
                } elseif ($params['btiebr'.$x] == 8) {
                    $sort_string .= " eprozent ASC ";
                } elseif ($params['btiebr'.$x] == 9) {
                    $sort_string .= " ebrett ASC ";
                }
            }
        }
    ...
    public function getCLMBestenliste($options = array())
    {
...
//			." LIMIT 20 "
    ...
    public function _getCLMBrett(&$options)
    {
        $sid	= clm_core::$load->request_int('saison', 1);
        $lid	= clm_core::$load->request_int('liga', 1);
        $db			= JFactory::getDBO();
    ...
    public function getCLMBrett($options = array())
    {
    ...
    public function _getCLMGBrett(&$options)
    {
        $sid	= clm_core::$load->request_int('saison', 1);
        $lid	= clm_core::$load->request_int('liga', 1);
        $db			= JFactory::getDBO();
    ...
    public function getCLMGBrett($options = array())
    {
    ...
    public static function CLMBrett_all($bretter)
    {
        ...
        for ($x = 1; $x < (1 + $bretter); $x++) {
            ...
            //if  ($x%2 == 0) {
            if ($x % 2 !== 0) {		//klkl
                if (isset($wu[$wuc]) and $wu[$wuc]->brett == $x) {
                    $sum_weiss = $wu[$wuc]->sum;
                    $wuc++;
                }
                if (isset($su[$suc]) and $su[$suc]->brett == $x) {
                    $sum_schwarz = $su[$suc]->sum;
                    $suc++;
                }

                // gerades Brett
            } else {
                if (isset($wg[$wgc]) and $wg[$wgc]->brett == $x) {
                    $sum_weiss = $wg[$wgc]->sum;
                    $wgc++;
                }
                if (isset($sg[$sgc]) and $sg[$sgc]->brett == $x) {
                    $sum_schwarz = $sg[$sgc]->sum;
                    $sgc++;
                }
            }
    ...
    public function _getCLMRBrett(&$options)
    {
        $sid	= clm_core::$load->request_int('saison', 1);
        $lid	= clm_core::$load->request_int('liga', 1);
        $db			= JFactory::getDBO();
    ...
    public function getCLMRBrett($options = array())
    {
    ...
    public function _getCLMKBrett(&$options)
    {
        $sid	= clm_core::$load->request_int('saison', 1);
        $lid	= clm_core::$load->request_int('liga', 1);
        $db			= JFactory::getDBO();
    ...
    public function getCLMKBrett($options = array())
    {
    ...
    public function _getCLMkvMannschaft(&$options)
    {
        $sid	= clm_core::$load->request_int('saison', 1);
        $lid	= clm_core::$load->request_int('liga', 1);
        $db			= JFactory::getDBO();
    ...
    public function getCLMkvMannschaft($options = array())
    {
    ...
    public function _getCLMkgMannschaft(&$options)
    {
        $sid	= clm_core::$load->request_int('saison', 1);
        $lid	= clm_core::$load->request_int('liga', 1);
        $db			= JFactory::getDBO();
    ...
    public function getCLMkgMannschaft($options = array())
    {
