...
*/
function clm_api_view_mail_confirm($return_section,$return_view,$cids) {

	$out = clm_core::$api->db_mail_confirm($return_section,$return_view,$cids);
	if (!$out[0]) {
	...
	$fix = clm_core::$load->load_view("mail_confirm", array($out[2]));
	return array(true, $out[1], '<div class="clm">'.$fix[1].'</div>');
}
?>
