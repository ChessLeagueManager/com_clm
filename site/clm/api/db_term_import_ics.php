...
function clm_api_db_term_import_ics($file, $test = false)
{
    ...
    //die();
    if ($debug > 0) {
        echo "<br><br> $lang->name : $lang->beschreibung";
    }
    $znr = 0;
    ...
    foreach ($lines as $line1) {
        ...
        if (ctype_upper(substr($line1, 0, 3))) {
            ...
            if (!$gpa or $akey == 'CLM-REST') {
                if ($debug > 0) {
                    echo "<br><br>$ii ungültige Folgezeile $line1 ";
                }
                continue;
            }
            $z++;
    ...
    foreach ($a_event as $event) {
        ...
        if ($debug > 0) {
            echo "<br><br>startdate ";
            var_dump($startdate);
        }
        if ($debug > 0) {
            echo "<br><br>starttime ";
            var_dump($starttime);
        }
        if ($debug > 0) {
            echo "<br><br>enddate ";
