...
function clm_api_db_draw_ch($turnierid, $dg, $round, $group = false, $test = false)
{
    ...
    if ($debug > 0) {
        echo "<br>Durchgang: ".$dg;
    } 	//echo "<br>end"; //die();
    if ($debug > 0) {
        echo "<br>Aktuelle Runde: ".$round;
    }
    ...
    if ($debug > 0) {
        echo "<br>Vereinstest bis Runde: ". $drawclubavoid;
    }
    if ($drawclubavoid > 0) {
    ...
    foreach ($erg_arunde as $erg1) {
        ...
        if ($erg1['heim'] == 0) {
            ...
            if (isset($players[$erg1['spieler'] - 1])) {
                unset($players[$erg1['spieler'] - 1]);
            }
            //				if (isset($ranglist[$players[$erg1['gegner']]])) unset($ranglist[$players[$erg1['gegner']]]);
            if (isset($players[$erg1['gegner'] - 1])) {
                unset($players[$erg1['gegner'] - 1]);
            }
        }
    }
