...
$online_import = clm_core::$load->load_view("spoiler",array($lang1->title.' ab 07/2026 (DSB-Server)',$fix1[1])); // array dereferencing fix php 5.3
$online_import = $online_import[1]; // array dereferencing fix php 5.3
$lang2 = clm_core::$lang->clmorg_import;
$fix1 = clm_core::$load->load_view("clmorg_import",array());
$clmorg_import = clm_core::$load->load_view("spoiler",array($lang2->title.' ab 07/2026 (CLM-Server)',$fix1[1])); // array dereferencing fix php 5.3
$clmorg_import = $clmorg_import[1]; // array dereferencing fix php 5.3
...
$country_import = clm_core::$load->load_view("spoiler",array($lang2->title.' ab 07/2026',$fix2[1])); // array dereferencing fix php 5.3
...
$output = '<div class="clm"><div class="clm_api_view_database">'.$clmorg_import.$online_import.$country_import.'</div></div>';
