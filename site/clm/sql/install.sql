...
CREATE TABLE IF NOT EXISTS `#__clm_dwz_spieler` (
  ...
  `Spielername` varchar(128) NOT NULL DEFAULT '',
  `Spielername_G` varchar(128) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__clm_dwz_verbaende` (
  ...
  `Verbandname` varchar(128) NOT NULL DEFAULT '',
  PRIMARY KEY (`Verband`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `#__clm_dwz_vereine` (
  ...
  `Vereinname` varchar(128) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `#__clm_images` (
  ...
  `width` int UNSIGNED NOT NULL COMMENT 'Breite in px',
  `height` int UNSIGNED NOT NULL COMMENT 'Höhe in px',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `#__clm_liga` (
  ...
  `catidAlltime` int UNSIGNED NOT NULL DEFAULT 0,
  `catidEdition` int UNSIGNED NOT NULL DEFAULT 0,
  `teil` int UNSIGNED DEFAULT NULL,
  `stamm` int UNSIGNED DEFAULT NULL,
  `ersatz` int UNSIGNED DEFAULT NULL,
  `rang` int UNSIGNED DEFAULT 0,
  `sl` int UNSIGNED DEFAULT NULL,
  `runden` int UNSIGNED DEFAULT NULL,
  `durchgang` int UNSIGNED DEFAULT NULL,
  `mail` int UNSIGNED DEFAULT NULL,
  `sl_mail` int UNSIGNED DEFAULT NULL,
  `heim` int UNSIGNED DEFAULT NULL,
  `sieg_bed` int UNSIGNED DEFAULT NULL,
  `runden_modus` int UNSIGNED DEFAULT NULL,
  `man_sieg` decimal(4,2) DEFAULT 2.00,
  `man_remis` decimal(4,2) DEFAULT 1.00,
  `man_nieder` decimal(4,2) DEFAULT 0.00,
  `man_antritt` decimal(4,2)  DEFAULT 0.00,
  `sieg` decimal(2,1) DEFAULT 1.0,
  `remis` decimal(2,1) DEFAULT 0.5,
  `nieder` decimal(2,1) DEFAULT 0.0,
  `antritt` decimal(2,1) DEFAULT 0.0,
  `order` int UNSIGNED DEFAULT NULL,
  `rnd` int UNSIGNED DEFAULT NULL,
  `auf` int UNSIGNED DEFAULT 0,
  `auf_evtl` int UNSIGNED DEFAULT 0,
  `ab` int UNSIGNED DEFAULT 0,
  `ab_evtl` int UNSIGNED DEFAULT 0,
  ...
  `b_wertung` int UNSIGNED DEFAULT 0,
  `liga_mt` int UNSIGNED DEFAULT 0,
  `tiebr1` int UNSIGNED NOT NULL DEFAULT 0,
  `tiebr2` int UNSIGNED NOT NULL DEFAULT 0,
  `tiebr3` int UNSIGNED NOT NULL DEFAULT 0,
  `ersatz_regel` int UNSIGNED DEFAULT 0,
  `anzeige_ma` int UNSIGNED DEFAULT 0,
  `params` text NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `#__clm_turniere_tlnr_wl`
--
