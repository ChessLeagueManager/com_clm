...
*/
	...
	Joomla.submitbutton = function (pressbutton) { 
		...
		if (form.name.value == "") {
			...
			alert( unescape(clm_mannschaft_mnr) );
		} else if (form.tln_nr.value == "") {
			alert( unescape(clm_mannschaft_tnr) );
		} else {
		...
		if ( val == 0 ) {
			alert( unescape(clm_mannschaft_sid) );
		} else {
			// get references to select list and display text box
		...
		if ( val == 0 ) {
			alert( unescape(clm_mannschaft_lid) );
		} else {
			// get references to select list and display text box
		...
		if ( val == 0 && clm_mannschaft_noOrg == 0 ) {
			alert( unescape(clm_mannschaft_zps) );
		} else {
			Joomla.submitform( pressbutton );
		}
	}
