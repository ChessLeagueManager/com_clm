...
class CLMSWT
{
    public static function readString($file, $offset, $length = 1)
    {
        $i = 0;
        $name = '';
    ...
    public static function readName($file, $offset, $length = 1)
    {
        return CLMSWT::readString($file, $offset, $length);
    }

    public static function readInt($file, $offset, $length = 1)
    {
        $value = 0;
        for ($i = 0; $i < $length; $i++) {
    ...
    public static function readBool($file, $offset)
    {
    ...
    public static function getFormValue($name, $default = null, $type = 'none', $keys = null)
    {
        if ($keys !== null) {
            $data = $_POST[$name];
