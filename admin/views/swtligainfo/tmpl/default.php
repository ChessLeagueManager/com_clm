...
?> 
				...
				<tr>
					...
					<td nowrap="nowrap">
						...
						<select name="durchgang" id="durchgang" value="<?php echo $this->swt_data['anz_durchgaenge']; ?>" size="1">
							<option value="1" <?php if ($this->swt_data['anz_durchgaenge'] < 2) {
							    echo 'selected="selected"';
							} ?>>1</option>
							<option value="2" <?php if ($this->swt_data['anz_durchgaenge'] == 2) {
							    echo 'selected="selected"';
							} ?>>2</option>
							<option value="3" <?php if ($this->swt_data['anz_durchgaenge'] == 3) {
							    echo 'selected="selected"';
							} ?>>3</option>
							<option value="4" <?php if ($this->swt_data['anz_durchgaenge'] == 4) {
							    echo 'selected="selected"';
							} ?>>4</option>
						</select>
					</td>
				...
				<tr>
					<td nowrap="nowrap">
						...
						<select name="ersatz_regel" id="ersatz_regel" value="<?php echo $this->lists['ersatz_regel']; ?>" size="1">
							<option value="0" <?php if ($this->lists['ersatz_regel'] == 0) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('LEAGUE_ERSATZ_REGEL_0');?></option>
							<option value="1" <?php if ($this->lists['ersatz_regel'] == 1) {
							    echo 'selected="selected"';
		...
		<label for="color_order"><?php echo JText::_('LEAGUE_COLOR_ORDER'); ?></label>
			...
			<option value="1" <?php if ($this->default['params']['color_order'] == 1) {
			    echo 'selected="selected"';
			} ?>><?php echo JText::_('LEAGUE_COLOR_ORDER_1');?></option>
			<option value="2" <?php if ($this->default['params']['color_order'] == 2) {
			    echo 'selected="selected"';
			} ?>><?php echo JText::_('LEAGUE_COLOR_ORDER_2');?></option>
			<option value="3" <?php if ($this->default['params']['color_order'] == 3) {
			    echo 'selected="selected"';
			} ?>><?php echo JText::_('LEAGUE_COLOR_ORDER_3');?></option>
			<option value="4" <?php if ($this->default['params']['color_order'] == 4) {
			    echo 'selected="selected"';
			} ?>><?php echo JText::_('LEAGUE_COLOR_ORDER_4');?></option>
			<option value="5" <?php if ($this->default['params']['color_order'] == 5) {
			    echo 'selected="selected"';
			} ?>><?php echo JText::_('LEAGUE_COLOR_ORDER_5');?></option>
			<option value="6" <?php if ($this->default['params']['color_order'] == 6) {
			    echo 'selected="selected"';
				...
				<tr>
					<td nowrap="nowrap">
						...
						<select name="runden_modus" id="runden_modus" value="<?php echo $this->swt_data['runden_modus']; ?>" size="1">
							<!-- <option>- wählen -</option> -->
							<option value="1" <?php if ($this->swt_data['runden_modus'] == 1) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_PAIRING_MODE_2');?></option>
							<option value="2" <?php if ($this->swt_data['runden_modus'] == 2) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_PAIRING_MODE_3');?></option>
							<option value="3" <?php if ($this->swt_data['runden_modus'] == 3) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_PAIRING_MODE_4');?></option>
							<option value="4" <?php if ($this->swt_data['runden_modus'] == 4) {
							    echo 'selected="selected"';
				...
				<tr>
					<td nowrap="nowrap">
						...
						<select name="tiebr1" id="tiebr1" value="<?php echo $this->swt_data['tiebr1']; ?>" size="1">
							<!--<option>- wählen -</option>-->
							<option value="0" <?php if ($this->swt_data['tiebr1'] == 0) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_SELECT_TIEBR_0');?></option>
							<option value="1" <?php if ($this->swt_data['tiebr1'] == 1) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_1');?></option>
							<option value="11" <?php if ($this->swt_data['tiebr1'] == 11) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_11');?></option>
							<option value="2" <?php if ($this->swt_data['tiebr1'] == 2) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_2');?></option>
							<option value="12" <?php if ($this->swt_data['tiebr1'] == 12) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_12');?></option>
							<option value="7" <?php if ($this->swt_data['tiebr1'] == 7) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_7');?></option>
							<option value="17" <?php if ($this->swt_data['tiebr1'] == 17) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_17');?></option>
							<option value="8" <?php if ($this->swt_data['tiebr1'] == 8) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_8');?></option>
							<option value="18" <?php if ($this->swt_data['tiebr1'] == 18) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_18');?></option>
							<option value="23" <?php if ($this->swt_data['tiebr1'] == 23) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_23');?></option>
							<option value="4" <?php if ($this->swt_data['tiebr1'] == 4) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_4');?></option>
							<option value="5" <?php if ($this->swt_data['tiebr1'] == 5) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_5');?></option>
							<option value="9" <?php if ($this->swt_data['tiebr1'] == 9) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_9');?></option>
							<option value="10" <?php if ($this->swt_data['tiebr1'] == 10) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_10');?></option>
							<option value="3" <?php if ($this->swt_data['tiebr1'] == 3) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_3');?></option>
							<option value="25" <?php if ($this->swt_data['tiebr1'] == 25) {
							    echo 'selected="selected"';
					...
					<td colspan="2">
						<select name="tiebr2" id="tiebr2" value="<?php echo $this->swt_data['tiebr2']; ?>" size="1">
							<!--<option>- wählen -</option>-->
							<option value="0" <?php if ($this->swt_data['tiebr2'] == 0) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_SELECT_TIEBR_0');?></option>
							<option value="1" <?php if ($this->swt_data['tiebr2'] == 1) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_1');?></option>
							<option value="11" <?php if ($this->swt_data['tiebr2'] == 11) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_11');?></option>
							<option value="2" <?php if ($this->swt_data['tiebr2'] == 2) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_2');?></option>
							<option value="12" <?php if ($this->swt_data['tiebr2'] == 12) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_12');?></option>
							<option value="7" <?php if ($this->swt_data['tiebr2'] == 7) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_7');?></option>
							<option value="17" <?php if ($this->swt_data['tiebr2'] == 17) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_17');?></option>
							<option value="8" <?php if ($this->swt_data['tiebr2'] == 8) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_8');?></option>
							<option value="18" <?php if ($this->swt_data['tiebr2'] == 18) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_18');?></option>
							<option value="23" <?php if ($this->swt_data['tiebr2'] == 23) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_23');?></option>
							<option value="4" <?php if ($this->swt_data['tiebr2'] == 4) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_4');?></option>
							<option value="5" <?php if ($this->swt_data['tiebr2'] == 5) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_5');?></option>
							<option value="9" <?php if ($this->swt_data['tiebr2'] == 9) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_9');?></option>
							<option value="10" <?php if ($this->swt_data['tiebr2'] == 10) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_10');?></option>
							<option value="3" <?php if ($this->swt_data['tiebr2'] == 3) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_3');?></option>
							<option value="25" <?php if ($this->swt_data['tiebr2'] == 25) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_25');?></option>
						</select>
					</td>
				...
				<tr>
					<td nowrap="nowrap">
						...
						<select name="tiebr3" id="tiebr3" value="<?php echo $this->swt_data['tiebr3']; ?>" size="1">
							<!--<option>- wählen -</option>-->
							<option value="0" <?php if ($this->swt_data['tiebr3'] == 0) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_SELECT_TIEBR_0');?></option>
							<option value="1" <?php if ($this->swt_data['tiebr3'] == 1) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_1');?></option>
							<option value="11" <?php if ($this->swt_data['tiebr3'] == 11) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_11');?></option>
							<option value="2" <?php if ($this->swt_data['tiebr3'] == 2) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_2');?></option>
							<option value="12" <?php if ($this->swt_data['tiebr3'] == 12) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_12');?></option>
							<option value="7" <?php if ($this->swt_data['tiebr3'] == 7) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_7');?></option>
							<option value="17" <?php if ($this->swt_data['tiebr3'] == 17) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_17');?></option>
							<option value="8" <?php if ($this->swt_data['tiebr3'] == 8) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_8');?></option>
							<option value="18" <?php if ($this->swt_data['tiebr3'] == 18) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_18');?></option>
							<option value="23" <?php if ($this->swt_data['tiebr3'] == 23) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_23');?></option>
							<option value="4" <?php if ($this->swt_data['tiebr3'] == 4) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_4');?></option>
							<option value="5" <?php if ($this->swt_data['tiebr3'] == 5) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_5');?></option>
							<option value="9" <?php if ($this->swt_data['tiebr3'] == 9) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_9');?></option>
							<option value="10" <?php if ($this->swt_data['tiebr3'] == 10) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_10');?></option>
							<option value="3" <?php if ($this->swt_data['tiebr3'] == 3) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_3');?></option>
							<option value="25" <?php if ($this->swt_data['tiebr3'] == 25) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('MTURN_TIEBR_25');?></option>
						</select>
					</td>
				...
				<tr>
					<td nowrap="nowrap">
						...
						<select name="runden_modus" id="runden_modus" value="<?php echo $this->runden_modus; ?>" size="1">
							<!--<option>- wählen -</option>-->
							<option value="1" <?php if ($this->default['runden_modus'] == 1) {
							    echo 'selected="selected"';
							} ?>><?php echo JText::_('LEAGUE_PAIRING_MODE_2');?></option>
							<option value="2" <?php if ($this->default['runden_modus'] == 2) {
							    echo 'selected="selected"';
		...
		<fieldset class="adminform">
			...
			<table class="paramlist admintable">
				...
				<tr>
					...
					<td>&nbsp;&nbsp;&nbsp;
						<input class="inputbox" type="text" name="sieg" id="sieg" size="4" maxlength="4" value="<?php if ($this->swt_data['std_wertung'] == false) {
						    echo $this->swt_data['siegpunkte'];
						} else {
						    echo "1";
						}; ?>" />
					</td>
					<td>&nbsp;&nbsp;&nbsp;
						<input class="inputbox" type="text" name="remis" id="remis" size="4" maxlength="4" value="<?php if ($this->swt_data['std_wertung'] == false) {
						    echo $this->swt_data['remispunkte'];
						} else {
						    echo "0.5";
						}; ?>" />
					</td>
					<td>&nbsp;&nbsp;&nbsp;
						<input class="inputbox" type="text" name="nieder" id="nieder" size="4" maxlength="4" value="<?php if ($this->swt_data['std_wertung'] == false) {
						    echo $this->swt_data['verlustpunkte'];
						} else {
						    echo "0";
						}; ?>" />
					</td>
					<td>&nbsp;&nbsp;&nbsp;
		          		<input class="inputbox" type="text" name="antritt" id="antritt" size="4" maxlength="4" value="<?php if ($this->swt_data['std_wertung'] == false) {
		          		    echo $this->swt_data['antrittspunkte'];
		          		} else {
		          		    echo "0";
		          		}; ?>" />
		          	</td>
				...
				<tr>
					...
					<td>&nbsp;&nbsp;&nbsp;
						<input class="inputbox" type="text" name="man_sieg" id="man_sieg" size="4" maxlength="4" value="<?php if ($this->swt_data['man_std_wertung'] == false) {
						    echo $this->swt_data['man_siegpunkte'];
						} else {
						    echo "2";
						}; ?>" />
					</td>
					<td>&nbsp;&nbsp;&nbsp;
						<input class="inputbox" type="text" name="man_remis" id="man_remis" size="4" maxlength="4" value="<?php if ($this->swt_data['man_std_wertung'] == false) {
						    echo $this->swt_data['man_remispunkte'];
						} else {
						    echo "1";
						}; ?>" />
					</td>
					<td>&nbsp;&nbsp;&nbsp;
						<input class="inputbox" type="text" name="man_nieder" id="man_nieder" size="4" maxlength="4" value="<?php if ($this->swt_data['man_std_wertung'] == false) {
						    echo $this->swt_data['man_verlustpunkte'];
						} else {
						    echo "0";
						}; ?>" />
					</td>
					<td>&nbsp;&nbsp;&nbsp;
						<input class="inputbox" type="text" name="man_antritt" id="man_antritt" size="4" maxlength="4" value="<?php if ($this->swt_data['man_std_wertung'] == false) {
						    echo $this->swt_data['man_antrittspunkte'];
						} else {
						    echo "0";
						}; ?>" />
					</td>
				...
				<tr>
					...
					<td colspan="2">&nbsp;&nbsp;
						<select name="sieg_bed" id="sieg_bed" value="<?php echo $this->swt_data['sieg_bed']; ?>" size="1">
							<option value="1" <?php if ($this->swt_data['sieg_bed'] == 1) {
							    echo 'selected="selected"';
							}  ?>>
								<?php echo JText::_('LEAGUE_WINNING_CONDITIONS_1');?>
							</option>
							<option value="2" <?php if ($this->swt_data['sieg_bed'] == 2) {
							    echo 'selected="selected"';
							}  ?>>
					...
					<td colspan="2">&nbsp;&nbsp;
						<select name="b_wertung" id="b_wertung" value="<?php echo $this->swt_data['b_wertung']; ?>" size="1">
							<option value="0" <?php if ($this->swt_data['b_wertung'] == 0) {
							    echo 'selected="selected"';
							}  ?>>
								<?php echo JText::_('LEAGUE_SCORE_CONDITIONS_0');?>
							</option>
							<option value="3" <?php if ($this->swt_data['b_wertung'] == 3) {
							    echo 'selected="selected"';
							}  ?>>
								<?php echo JText::_('LEAGUE_SCORE_CONDITIONS_3');?>
							</option>
							<option value="4" <?php if ($this->swt_data['b_wertung'] == 4) {
							    echo 'selected="selected"';
							}  ?>>
