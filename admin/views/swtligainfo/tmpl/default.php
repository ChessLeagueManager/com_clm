...
<script language="javascript" type="text/javascript">
        ...
        // do field validation
        if (form.name.value == "") {
            alert( "<?php echo Text::_( 'LEAGUE_HINT_1', true ); ?>" );
		} else {
...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			<legend><?php echo Text::_( 'LEAGUE_DATA' ); ?></legend>
			<table class="paramlist admintable">
			
				<tr>
					<td width="20%" nowrap="nowrap">
						<label for="name"><?php echo Text::_( 'LEAGUE_NAME' ); ?></label>
					</td>
					<td colspan="2">
						<input class="inputbox" type="text" name="name" id="name" size="20" maxlength="30" value="<?php echo $this->swt_data['liga_name']; ?>" />
                    </td>
                    <td nowrap="nowrap">
                        <label for="sl"><?php echo Text::_( 'LEAGUE_CHIEF' ); ?></label>
                        </td><td colspan="2">
                    ...
                    <td colspan="2">
                        <?php
                        	if ($this->rang == 0) {
 	                    	...
 	                    	elseif ($this->rang == 1) {
 	                    		echo Text::_( 'LEAGUE_LIST_TYPE_DEFAULT_RANK' );
 	                    		// siehe zusaetzlich unten
 	                    	}
 	                    	elseif ($this->rang == 2) {
 	                    		echo Text::_( 'LEAGUE_LIST_TYPE_DEFAULT_LIST' );
 	                    		// siehe zusaetzlich unten
 	                    	}
 	                    ?> 
                    </td>
			...
			<tr>
				...
				<td colspan="2">
					<?php echo CLMForm::calendar($this->swt_data['dateStart'], "dateStart", "dateStart", '%Y-%m-%d', array('class'=>'text_area', 'size'=>'12',  'maxlength'=>'19')); ?>
				</td>
				...
				<td>
					<?php echo CLMForm::calendar($this->swt_data['dateEnd'], "dateEnd", "dateEnd", '%Y-%m-%d', array('class'=>'text_area', 'size'=>'12',  'maxlength'=>'19')); ?>
				</td>
			</tr>
					<td nowrap="nowrap">
				...
				<tr>
					<td nowrap="nowrap">
						...
						<select name="ersatz_regel" id="ersatz_regel" value="<?php echo $this->lists['ersatz_regel']; ?>" size="1">
							<option value="0" <?php if ($this->lists['ersatz_regel'] == 0) {echo 'selected="selected"';} ?>><?php echo Text::_( 'LEAGUE_ERSATZ_REGEL_0' );?></option>
							<option value="1" <?php if ($this->lists['ersatz_regel'] == 1) {echo 'selected="selected"';} ?>><?php echo Text::_( 'LEAGUE_ERSATZ_REGEL_1' );?></option>
						</select>
					</td>
					<td nowrap="nowrap">
				...
				<tr>
		<td nowrap="nowrap">
		<label for="color_order"><?php echo Text::_( 'LEAGUE_COLOR_ORDER' ); ?></label>
		</td><td colspan="2">
			<select name="color_order" id="color_order" value="<?php echo $this->default['params']['color_order']; ?>" size="1">
			<!--<option>- wählen -</option>-->
			<option value="1" <?php if ($this->default['params']['color_order'] == 1) {echo 'selected="selected"';} ?>><?php echo Text::_( 'LEAGUE_COLOR_ORDER_1' );?></option>
			<option value="2" <?php if ($this->default['params']['color_order'] == 2) {echo 'selected="selected"';} ?>><?php echo Text::_( 'LEAGUE_COLOR_ORDER_2' );?></option>
			<option value="3" <?php if ($this->default['params']['color_order'] == 3) {echo 'selected="selected"';} ?>><?php echo Text::_( 'LEAGUE_COLOR_ORDER_3' );?></option>
			<option value="4" <?php if ($this->default['params']['color_order'] == 4) {echo 'selected="selected"';} ?>><?php echo Text::_( 'LEAGUE_COLOR_ORDER_4' );?></option>
			<option value="5" <?php if ($this->default['params']['color_order'] == 5) {echo 'selected="selected"';} ?>><?php echo Text::_( 'LEAGUE_COLOR_ORDER_5' );?></option>
			<option value="6" <?php if ($this->default['params']['color_order'] == 6) {echo 'selected="selected"';} ?>><?php echo Text::_( 'LEAGUE_COLOR_ORDER_6' );?></option>
			</select>
		</td>
				...
				<tr>
					<td nowrap="nowrap">
						...
						<select name="runden_modus" id="runden_modus" value="<?php echo $this->swt_data['runden_modus']; ?>" size="1">
							<!-- <option>- wählen -</option> -->
							<option value="1" <?php if ($this->swt_data['runden_modus'] == 1) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_PAIRING_MODE_2' );?></option>
							<option value="2" <?php if ($this->swt_data['runden_modus'] == 2) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_PAIRING_MODE_3' );?></option>
							<option value="3" <?php if ($this->swt_data['runden_modus'] == 3) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_PAIRING_MODE_4' );?></option>
							<option value="4" <?php if ($this->swt_data['runden_modus'] == 4) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_PAIRING_MODE_5' );?></option>
						</select>
					</td>
					<td nowrap="nowrap">
				...
				<tr>
					<td nowrap="nowrap">
						...
						<select name="tiebr1" id="tiebr1" value="<?php echo $this->swt_data['tiebr1']; ?>" size="1">
							<!--<option>- wählen -</option>-->
							<option value="0" <?php if ($this->swt_data['tiebr1'] == 0) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_SELECT_TIEBR_0' );?></option>
							<option value="1" <?php if ($this->swt_data['tiebr1'] == 1) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_1' );?></option>
							<option value="11" <?php if ($this->swt_data['tiebr1'] == 11) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_11' );?></option>
							<option value="2" <?php if ($this->swt_data['tiebr1'] == 2) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_2' );?></option>
							<option value="12" <?php if ($this->swt_data['tiebr1'] == 12) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_12' );?></option>
							<option value="7" <?php if ($this->swt_data['tiebr1'] == 7) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_7' );?></option>
							<option value="17" <?php if ($this->swt_data['tiebr1'] == 17) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_17' );?></option>
							<option value="8" <?php if ($this->swt_data['tiebr1'] == 8) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_8' );?></option>
							<option value="18" <?php if ($this->swt_data['tiebr1'] == 18) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_18' );?></option>
							<option value="23" <?php if ($this->swt_data['tiebr1'] == 23) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_23' );?></option>
							<option value="4" <?php if ($this->swt_data['tiebr1'] == 4) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_4' );?></option>
							<option value="5" <?php if ($this->swt_data['tiebr1'] == 5) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_5' );?></option>
							<option value="9" <?php if ($this->swt_data['tiebr1'] == 9) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_9' );?></option>
							<option value="10" <?php if ($this->swt_data['tiebr1'] == 10) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_10' );?></option>
							<option value="3" <?php if ($this->swt_data['tiebr1'] == 3) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_3' );?></option>
							<option value="33" <?php if ($this->swt_data['tiebr1'] == 33) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_33' );?></option>
							<option value="25" <?php if ($this->swt_data['tiebr1'] == 25) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_25' );?></option>
						</select>
					</td>
					<td nowrap="nowrap">
					...
					<td colspan="2">
						<select name="tiebr2" id="tiebr2" value="<?php echo $this->swt_data['tiebr2']; ?>" size="1">
							<!--<option>- wählen -</option>-->
							<option value="0" <?php if ($this->swt_data['tiebr2'] == 0) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_SELECT_TIEBR_0' );?></option>
							<option value="1" <?php if ($this->swt_data['tiebr2'] == 1) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_1' );?></option>
							<option value="11" <?php if ($this->swt_data['tiebr2'] == 11) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_11' );?></option>
							<option value="2" <?php if ($this->swt_data['tiebr2'] == 2) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_2' );?></option>
							<option value="12" <?php if ($this->swt_data['tiebr2'] == 12) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_12' );?></option>
							<option value="7" <?php if ($this->swt_data['tiebr2'] == 7) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_7' );?></option>
							<option value="17" <?php if ($this->swt_data['tiebr2'] == 17) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_17' );?></option>
							<option value="8" <?php if ($this->swt_data['tiebr2'] == 8) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_8' );?></option>
							<option value="18" <?php if ($this->swt_data['tiebr2'] == 18) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_18' );?></option>
							<option value="23" <?php if ($this->swt_data['tiebr2'] == 23) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_23' );?></option>
							<option value="4" <?php if ($this->swt_data['tiebr2'] == 4) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_4' );?></option>
							<option value="5" <?php if ($this->swt_data['tiebr2'] == 5) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_5' );?></option>
							<option value="9" <?php if ($this->swt_data['tiebr2'] == 9) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_9' );?></option>
							<option value="10" <?php if ($this->swt_data['tiebr2'] == 10) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_10' );?></option>
							<option value="3" <?php if ($this->swt_data['tiebr2'] == 3) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_3' );?></option>
							<option value="33" <?php if ($this->swt_data['tiebr2'] == 33) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_33' );?></option>
							<option value="25" <?php if ($this->swt_data['tiebr2'] == 25) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_25' );?></option>
						</select>
					</td>
				</tr>
				<tr>
					<td nowrap="nowrap">
						...
						<select name="tiebr3" id="tiebr3" value="<?php echo $this->swt_data['tiebr3']; ?>" size="1">
							<!--<option>- wählen -</option>-->
							<option value="0" <?php if ($this->swt_data['tiebr3'] == 0) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_SELECT_TIEBR_0' );?></option>
							<option value="1" <?php if ($this->swt_data['tiebr3'] == 1) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_1' );?></option>
							<option value="11" <?php if ($this->swt_data['tiebr3'] == 11) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_11' );?></option>
							<option value="2" <?php if ($this->swt_data['tiebr3'] == 2) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_2' );?></option>
							<option value="12" <?php if ($this->swt_data['tiebr3'] == 12) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_12' );?></option>
							<option value="7" <?php if ($this->swt_data['tiebr3'] == 7) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_7' );?></option>
							<option value="17" <?php if ($this->swt_data['tiebr3'] == 17) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_17' );?></option>
							<option value="8" <?php if ($this->swt_data['tiebr3'] == 8) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_8' );?></option>
							<option value="18" <?php if ($this->swt_data['tiebr3'] == 18) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_18' );?></option>
							<option value="23" <?php if ($this->swt_data['tiebr3'] == 23) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_23' );?></option>
							<option value="4" <?php if ($this->swt_data['tiebr3'] == 4) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_4' );?></option>
							<option value="5" <?php if ($this->swt_data['tiebr3'] == 5) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_5' );?></option>
							<option value="9" <?php if ($this->swt_data['tiebr3'] == 9) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_9' );?></option>
							<option value="10" <?php if ($this->swt_data['tiebr3'] == 10) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_10' );?></option>
							<option value="3" <?php if ($this->swt_data['tiebr3'] == 3) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_3' );?></option>
							<option value="33" <?php if ($this->swt_data['tiebr3'] == 33) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_33' );?></option>
							<option value="25" <?php if ($this->swt_data['tiebr3'] == 25) {echo 'selected="selected"';} ?>><?php echo Text::_( 'MTURN_TIEBR_25' );?></option>
						</select>
					</td>
					...
					<td class="paramlist_value"><fieldset class="radio">
						<?php echo HTMLHelper::_('select.booleanlist', 'optionTiebreakersFideCorrect', 'class="inputbox"', $this->swt_data['optionTiebreakersFideCorrect']); ?>
					</fieldset></td>
				</tr>
<?php } ?>
...
<?php if ($mturnier != 1) { // $mturnier != 1 ?>
				<tr>
					<td nowrap="nowrap">
						<label for="runden_modus"><?php echo Text::_( 'LEAGUE_PAIRING_MODE' ); ?></label>
						</td><td colspan="2">
						<select name="runden_modus" id="runden_modus" value="<?php echo $this->runden_modus; ?>" size="1">
							<!--<option>- wählen -</option>-->
							<option value="1" <?php if ($this->default['runden_modus'] == 1) {echo 'selected="selected"';} ?>><?php echo Text::_( 'LEAGUE_PAIRING_MODE_2' );?></option>
							<option value="2" <?php if ($this->default['runden_modus'] == 2) {echo 'selected="selected"';} ?>><?php echo Text::_( 'LEAGUE_PAIRING_MODE_3' );?></option>
						</select>
					</td>
					<td nowrap="nowrap">
						<label for="heim"><?php echo Text::_( 'LEAGUE_HOME' ); ?></label>
...
<!-- bis hier Liga-Eingabemaske -->
			<tr>
				<td nowrap="nowrap">
					<label for="pseudo_dwz"><?php echo Text::_( 'LEAGUE_PSEUDO_DWZ' ); ?></label>
				</td><td colspan="2">
			...
			<tr>
				...
				<td class="paramlist_value" title="<?php echo Text::_( 'TOURNAMENT_CITY_HINT' ); ?>">
					<input class="inputbox" type="text" name="city" id="city" size="31" maxlength="60" value="<?php echo $this->swt_data['city']; ?>" />
				</td>
				...
				<td class="paramlist_value">
					<input class="inputbox" type="text" name="FIDEcco" id="FIDEcco" size="3" maxlength="3" value="<?php echo $this->swt_data['FIDEcco']; ?>" />
				</td>
			</tr>
		</fieldset>
					...
					<td colspan="2">&nbsp;&nbsp;
						<select name="sieg_bed" id="sieg_bed" value="<?php echo $this->swt_data['sieg_bed']; ?>" size="1">
							<option value="1" <?php if ($this->swt_data['sieg_bed'] == 1) {echo 'selected="selected"';}  ?>>
								<?php echo Text::_( 'LEAGUE_WINNING_CONDITIONS_1' );?>
							</option>
							<option value="2" <?php if ($this->swt_data['sieg_bed'] == 2) {echo 'selected="selected"';}  ?>>
								<?php echo Text::_( 'LEAGUE_WINNING_CONDITIONS_2' );?>
							</option>
						</select>
					</td>
					<td nowrap="nowrap">
	...
	<div class="width-40 fltrt">
		<fieldset class="adminform">
			...
			<table class="paramlist admintable">
				<legend><?php echo Text::_( 'SWT_DWZ_HANDLING' ); ?></legend>
				<tr>
					<td style="text-align: left;">					
						<label for="dwz_trans_1">
						<input type="radio" id="dwz_trans_1" name="dwz_handling" value="1" >
						<?php echo '&nbsp;'.Text::_( 'SWT_DWZ_HANDLING_1' ); ?></label>
						<label for="dwz_trans_0">
						<input type="radio" id="dwz_trans_0" name="dwz_handling" value="0" checked="checked" >
						<?php echo '&nbsp;'.Text::_( 'SWT_DWZ_HANDLING_0' ); ?></label>
					</td>
				</tr>
			</table>
			<br>
				<legend><?php echo Text::_( 'SWT_SP_ACTIONS' ); ?></legend>
				<tr>
					<td nowrap="nowrap">
						<label for="name_land"><?php echo Text::_( 'SWT_NAME_LAND' ); ?></label>
					</td>
		...
		<fieldset>
			...
			<b><?php echo Text::_( 'LEAGUE_HINTS_PAIRING_MODE' ); ?></b>

			<?php
				for ($i = 1; $i <= 28; $i++) {
					echo Text::_( 'LEAGUE_HINTS_' . $i );
				}
			?>
			<!--
