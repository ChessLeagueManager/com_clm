		...
		<table class="admintable">
			...
			<tr>
				...
				<td class="paramlist_value">
					...
					echo HTMLHelper::_('select.genericlist', $optionlist, 'geschlecht', 'class="inputbox"', 'id', 'name', $this->registration->geschlecht);
					?>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="key" nowrap="nowrap"><?php echo Text::_('PLAYER_COMMENT'); ?>:</td>
