...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	...
	<table>
		<tr>
			...
			<td nowrap="nowrap">
				<?php
//					echo "&nbsp;&nbsp;&nbsp;".HTMLHelper::_('grid.state',  $this->param['state'] );
		...
		<thead>
			<tr>
				...
				<th width="6%">
					<?php echo HTMLHelper::_('grid.sort', Text::_('TERMINE_DATUM'), 'a.startdate', $this->param['order_Dir'], $this->param['order'] ); ?>
				</th>
				<th width="4%">
					<?php echo HTMLHelper::_('grid.sort', Text::_('RUNDE_STARTTIME'), 'a.starttime', $this->param['order_Dir'], $this->param['order'] ); ?>
				</th>
				<th class="title">
					<?php echo HTMLHelper::_('grid.sort', Text::_('TERMINE_TASK'), 'a.name', $this->param['order_Dir'], $this->param['order'] ); ?>
				</th>
				<th>
					<?php echo HTMLHelper::_('grid.sort', Text::_('TERMINE_DESCRIPTION'), 'a.beschreibung', $this->param['order_Dir'], $this->param['order'] ); ?>
				</th>

				<th>
					<?php echo HTMLHelper::_('grid.sort', Text::_('TERMINE_EVENT_LINK'), 'a.event_link', $this->param['order_Dir'], $this->param['order'] ); ?>
				</th>

				<th>
					<?php echo HTMLHelper::_('grid.sort', Text::_('TERMINE_ADRESS'), 'a.address', $this->param['order_Dir'], $this->param['order'] ); ?>
				</th>
				<th width="10%">
					<?php echo HTMLHelper::_('grid.sort', Text::_('TERMINE_KATEGORIE'), 'category', $this->param['order_Dir'], $this->param['order'] ); ?>
				</th>
				<th width="16%">
					<?php echo HTMLHelper::_('grid.sort', Text::_('TERMINE_HOST'), 'hostname', $this->param['order_Dir'], $this->param['order'] ); ?>
				</th>

				<th width="3%">
					<?php echo HTMLHelper::_('grid.sort', Text::_('TERMINE_PUBLISHED'), 'a.published', $this->param['order_Dir'], $this->param['order'] ); ?>
				</th>
...
//			$published 	= HTMLHelper::_('grid.published', $row, $i );
			...
			<tr class="<?php echo 'row'. $k; ?>">
				...
				<td align="left">
					<?php echo HTMLHelper::_( 'date', $row->startdate, Text::_('DATE_FORMAT_CLM'));?>
					<?php if ($row->enddate != 0 AND $row->enddate != '0000-00-00' AND $row->enddate != '1970-01-01' AND $row->enddate != $row->startdate) { 
								echo "&nbsp;-&nbsp;". HTMLHelper::_( 'date', $row->enddate, Text::_('DATE_FORMAT_CLM')); }?>
				</td>
				<td align="center">
				...
				<td>
					<?php
						...
						?>
						<span class="editlinktip hasTip" title="<?php echo Text::_( 'EDIT' );?>::<?php echo $row->name; ?>">
