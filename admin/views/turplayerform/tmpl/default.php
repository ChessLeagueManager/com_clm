...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	...
	<div class="width-70 fltlft">
		<fieldset class="adminform">
			<legend><?php echo Text::_( 'FROM_RATING_DATABASE' ); ?></legend>
				...
				<button onclick="document.getElementById('search').value='';this.form.getElementById('filter_catid').value='0';this.form.getElementById('filter_state').value='';this.form.submit();"><?php echo Text::_( 'RESET' ); ?></button>
					...
					<thead>
						<tr>
							...
							<th class="title">
								<?php echo HTMLHelper::_('grid.sort',   Text::_('PLAYER_NAME'), 'Spielername', $this->param['order_Dir'], $this->param['order'] ); ?>
							</th>
							<th width="5%">
								<?php echo HTMLHelper::_('grid.sort',   Text::_('PLAYER_TITLE'), 'FIDE_Titel', $this->param['order_Dir'], $this->param['order'] ); ?>
							</th>
							<th width="5%">
								<?php echo HTMLHelper::_('grid.sort',   Text::_('CLM_NUMBER_ABB'), 'snr', $this->param['order_Dir'], $this->param['order'] ); ?>
							</th>
							<th width="7%">
								<?php echo HTMLHelper::_('grid.sort',   Text::_('RATING'), 'DWZ', $this->param['order_Dir'], $this->param['order'] ); ?>
							</th>
							<th width="7%">
								<?php echo HTMLHelper::_('grid.sort',   Text::_('FIDE_ELO'), 'FIDE_Elo', $this->param['order_Dir'], $this->param['order'] ); ?>
							</th>
							<th width="28%">
								<?php echo HTMLHelper::_('grid.sort',   Text::_('CLUB'), 'Vereinname', $this->param['order_Dir'], $this->param['order'] ); ?>
							</th>
						</tr>
					</thead>
					<tfoot>
	...
	<div class="width-30 fltrt">
		<fieldset class="adminform">
			<legend><?php echo Text::_( 'ENTER_PLAYERS_BY_NAME' ); ?></legend>
			<table class="admintable">
				...
				<tr>
					...
					<td class="paramlist_value">
						...
						echo HTMLHelper::_('select.genericlist', $optionlist, 'geschlecht', 'class="inputbox"', 'id', 'name', '');
						?>
					</td>
				</tr>
				<tr>
		...
		* <span style="font-size: 80%; font-weight: lighter;"><?php echo Text::_('MANDATORY_ITEM'); ?></span><br>
		** <span style="font-size: 80%; font-weight: lighter;"´><?php echo Text::_('Notwendig, wenn DWZ-Auswertung geplant ist'); ?></span>
		</fieldset>
	</div>
