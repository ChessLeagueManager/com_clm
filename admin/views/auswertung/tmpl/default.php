...
<div class="width-50 fltlft">
	...
	<legend><?php echo Text::_( 'DB_EXPORT_FILES' ); ?></legend>
			...
			<table width="100%">
				...
				<tr>
					<td width="70%" nowrap="nowrap" title="<?php echo Text::_( 'DEWIS_FROM_ROUND_HINT' ); ?>">
						<label for="lround"><?php echo Text::_( 'DEWIS_FROM_ROUND' ); ?></label>
					</td>
					<td width="30%" nowrap="nowrap" title="<?php echo Text::_( 'DEWIS_FROM_ROUND_HINT' ); ?>">
						<input class="inputbox" type="text" name="lround" id="lround" size="10" maxlength="6" value=""/>
					</td>
				</tr>
				<tr>
					<td width="70%" nowrap="nowrap" title="<?php echo Text::_( 'DEWIS_AND_PAIRING_HINT' ); ?>">
						<label for="lpairing"><?php echo Text::_( 'DEWIS_AND_PAIRING' ); ?></label>
					</td>
					<td width="30%" nowrap="nowrap" title="<?php echo Text::_( 'DEWIS_AND_PAIRING_HINT' ); ?>">
	...
	<?php //if ($countryversion =="de") { ?>		
		...
		<legend><?php echo Text::_( 'DB_EXPORT_TEAMTOURNAMENT' ); ?></legend> 
			<table width="100%">
				...
				<tr>
					<td width="70%" nowrap="nowrap" title="<?php echo Text::_( 'DEWIS_FROM_ROUND_HINT' ); ?>">
						<label for="mround"><?php echo Text::_( 'DEWIS_FROM_ROUND' ); ?></label>
					</td>
					<td width="30%" nowrap="nowrap" title="<?php echo Text::_( 'DEWIS_FROM_ROUND_HINT' ); ?>">
				...
				<tr>
					<td width="70%" nowrap="nowrap" title="<?php echo Text::_( 'DEWIS_AND_PAIRING_HINT' ); ?>">
						<label for="mpairing"><?php echo Text::_( 'DEWIS_AND_PAIRING' ); ?></label>
					</td>
					<td width="30%" nowrap="nowrap" title="<?php echo Text::_( 'DEWIS_AND_PAIRING_HINT' ); ?>">
