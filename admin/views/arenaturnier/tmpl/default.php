		...
		<tr>
			<td width="45%" style="vertical-align: top;">
				<fieldset class="adminform"> 
					...
					<?php echo Text::_( 'ARENA_ATTENTION_TEXT01' ); ?>
					<?php echo Text::_( 'ARENA_ATTENTION_TEXT02' ); ?>
					<br><br>
				</fieldset>
				<fieldset class="adminform"> 
					<legend style="font-size:130%;line-height:100%;margin-bottom:10px;"><?php echo Text::_( 'SWT_ACTIVATION_TAB' ); ?></legend> 
						<?php echo Text::_( 'ARENA_ACTIVATION_TEXT02' ).' '; ?><?php if ($execute == 1) { ?><font color="#00ff00"><?php echo Text::_( 'SWT_ACTIVE' ); } 
				...
				<fieldset class="adminform"> 
					...
					<?php echo Text::_( 'ARENA_HINTS_TEXT01' ); ?>
					<?php echo Text::_( 'ARENA_HINTS_TEXT02' ); ?>
					<?php echo Text::_( 'ARENA_HINTS_TEXT03' ); ?>
				</fieldset>
			</td>
			...
			<td width="50%" style="vertical-align: top;">
				<?php if ($execute == 1) { ?>
				<fieldset class="adminform"> 
					<legend style="font-size:130%;line-height:100%;margin-bottom:10px;"><?php echo Text::_( 'ARENA_EXECUTE_TAB' ); ?></legend> 
					<table width="100%">
						<tr>
							...
							<td width="50%"><?php echo Text::_( 'ARENA_EXECUTE_TEXT' ); ?></td>
						</tr>
					</table>
				</fieldset>
				<br>
