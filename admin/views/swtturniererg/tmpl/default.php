...
<!---fieldset class='adminform' >
	<legend><?php echo Text::_('SWT_CHOOSE_ROUND'); ?></legend>
	<table class='admintable' width='50%'>
		<tbody>
			<tr>
				<td class='key' width='20%' nowrap='nowrap'><?php echo Text::_('SWT_CHOOSE_ROUND_HINT'); ?></td>
				<td><?php echo HTMLHelper::_('select.genericlist', $this->runden_options, 'runden_filter', 'class="inputbox" autocomplete="off" onchange="showRounds()"', 'value', 'text', 1, false); ?></td>
			</tr>
		</tbody>
	</table>
</fieldset>
...
foreach($this->runden as $rnd => $runde) {
	...
	<legend>".Text::_('ROUND')." ".$runde->runde.", ".Text::_('DG')." ".$runde->dg." (".$runde->name.")</legend>
						...
						<table class='admintable'>
							<tr>
								<td class='key' width='20%' nowrap='nowrap'>
									<label for='name'>".Text::_( 'ROUND_NAME' ).":</label>
								</td>
								<td>
							...
							<tr>
								<td width='100' class='key'>
									<label for='datum'>".Text::_( 'JDATE' ).":</label>
								</td>
								<td>
									".HTMLHelper::_('calendar', $runde->datum, 'datum['.$rnd.']', 'datum['.$rnd.']', '%Y-%m-%d', array('class'=>'text_area', 'size'=>'32',  'maxlength'=>'19'))."
								</td>
							</tr>

							<tr>
								<td class='key' nowrap='nowrap'>
									<label for='startzeit'>".Text::_( 'RUNDE_STARTTIME' ).":</label>
								</td>
								<td>
							...
							<tr>
								<td class='key' nowrap='nowrap'>
									<label for='published'>".Text::_( 'CLM_PUBLISHED' ).":</label>
								</td>
							...
							<tr>
								<td class='key' nowrap='nowrap'>
									<label for='verein'>".Text::_( 'ENTRY_ENABLED' )."</label>
								</td>
								<td><fieldset class='radio'>
									".HTMLHelper::_('select.booleanlist',  'abgeschlossen['.$rnd.']', "class='inputbox'", $runde->abgeschlossen )."
								</fieldset></td>
							</tr>

							<tr>
								<td class='key' nowrap='nowrap'>
									<label for='mf'>".Text::_('TOURNAMENT_DIRECTOR').' '.Text::_( 'APPROVAL' ).":</label>
								</td>
								<td><fieldset class='radio'>
									".HTMLHelper::_('select.booleanlist',  'tl_ok['.$rnd.']', "class='inputbox'", $runde->tl_ok )."
								</fieldset></td>
							</tr>
						</table>
					</fieldset>";
	...
	echo"
					<fieldset class='adminform'>
						<legend>".Text::_( 'REMARKS' )."</legend>
						
						<table class='admintable'>
							<tr>
								<td width='20%' class='key' nowrap='nowrap'>
									<label for='mf'>".Text::_( 'REMARKS_PUBLIC' ).":</label>
								</td>
								<td valign='top'>
							...
							<tr>
								<td width='20%' class='key' nowrap='nowrap'>
									<label for='mf'>".Text::_( 'REMARKS_INTERNAL' ).":</label>
								</td>
								<td valign='top'>
	...
	echo"
				<td width='50%' style='vertical-align: top;'>
					<fieldset class='adminform'>
						<legend>".Text::_('PAIRINGS')."</legend>
						<div id='editcell'> 
							<table class='adminlist'>
								<thead>
									<tr>
										<th width='10'>".Text::_('PAIRING')."</th>
										<th width=''>".Text::_('WHITE')."</th>
										<th width=''>".Text::_('BLACK')."</th>
										<th width='100'>".Text::_('RESULT')."</th>		
									</tr>
								</thead>
								<tfoot>
									<tr>
								...
								if ($max_rnd >= $rnd) {
								  foreach($this->matches[$rnd] as $brett => $match) {
									echo "<tr class='row".$k."'>";
										...
										echo "<td>".HTMLHelper::_('select.genericlist', $this->teilnehmer_options, 'spieler['.$rnd.']['.$brett.']', 'class="inputbox" autocomplete="off"', 'value', 'text', $match->spieler, false)."</td>";
										echo "<td>".HTMLHelper::_('select.genericlist', $this->teilnehmer_options, 'gegner['.$rnd.']['.$brett.']', 'class="inputbox" autocomplete="off"', 'value', 'text', $match->gegner, false)."</td>";
										echo "<td>".HTMLHelper::_('select.genericlist', $this->ergebnis_options, 'ergebnisWhite['.$rnd.']['.$brett.']', 'class="inputbox" autocomplete="off"', 'value', 'text', $match->ergebnisWhite, false)."
