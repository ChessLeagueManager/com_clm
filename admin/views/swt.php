...
function setImport_1Toolbar ($execute,$upload)
	...
	ToolBarHelper::title(   Text::_( 'SWT_STEP1' ), 'clm_headmenu_manager.png' );
	ToolBarHelper::custom('import_2','apply.png','apply_f2.png','SWT_STEP2',false);
	ToolBarHelper::custom('back','apply.png','apply_f2.png','SWT_BACK',false);
	}
...
function Import_1 (&$spieler, &$lists,&$man, &$swt, &$man_zps, &$vereine, &$sid, $fileName, &$name_manuell)
	...
	<table class="admintable">
		<tr><th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_EVENT' ); ?>&nbsp;&nbsp;&nbsp;</th><th class="key" nowrap="nowrap"><?php echo $veranstaltung; ?></td><tr>
		<tr><th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_TYPE' ); ?></th><th class="key" nowrap="nowrap"><?php if ($swt[607] == 255) { echo "Mannschaftsturnier !";} else {echo "Einzelturnier ! ";} ?></td><tr>
		<tr><th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_NAME' ); ?></th><th class="key" nowrap="nowrap"><?php echo $liga_name; ?></td><tr>
		<tr><th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_MANNSCHAFTEN' ); ?></th><th class="key" nowrap="nowrap"><?php echo $swt[603]; ?></td><tr>
		<tr><th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_RUNDEN' ); ?></th><th class="key" nowrap="nowrap"><?php echo $swt[2]; ?></td><tr>
		<tr><th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_AKT_RUNDE' ); ?></th><th class="key" nowrap="nowrap"><?php echo $swt[4]; ?></td><tr>
		<tr><th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_BRETTER' ); ?></th><th class="key" nowrap="nowrap"><?php echo $swt[605]; ?></td><tr>
		<tr><th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_SPIELER' ); ?></th><th class="key" nowrap="nowrap"><?php echo $swt[8]; ?></td><tr>
		<tr><th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_DURCHGAENGE' ); ?></th><th class="key" nowrap="nowrap"><?php echo $swt[599]; ?></td><tr>
		<tr><th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_AKT_DG' ); ?></th><th class="key" nowrap="nowrap"><?php echo $swt[600]; ?></td><tr>
	</table>
	</fieldset>
	</div>
	...
	<div>
	<fieldset>
	<legend><?php echo Text::_( 'SWT_TIPS' ); ?></legend>
	<?php echo Text::_( 'SWT_TIP_LINE1' ); ?><br>
	<br><?php echo Text::_( 'SWT_TIP_LINE1A' ); ?><b><?php echo Text::_( 'SWT_TIP_LINE1B' ); ?></b><br>
	<br><?php echo Text::_( 'SWT_TIP_LINE2' ); ?><br>
	<br><?php echo Text::_( 'SWT_TIP_LINE3' ); ?> 
	...
	<div>
		<fieldset>
		<legend><?php echo Text::_( 'SWT_MANNSCHAFTEN' ); ?></legend>
		
		<table class="admintable">
			<tr>
				<th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_TLN_NR' ); ?></th>
				<th class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_MANNSCHAFT' ); ?></th>
				<th width="6%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_ZPS' ); ?></th>
				<th width="27%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_VEREIN' ); ?></th>
				<th width="27%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_OPT_NAME' ); ?></th>
			</tr>
			<?php 
			...
			<tr>
				...
				<td width="27%" class="key" nowrap="nowrap">
				  <select size="1" name="<?php echo 'zps'.$man; ?>" id="<?php echo 'zps'.$man; ?>">
					<option value="0"><?php echo Text::_( 'SWT_VEREIN_AUSWAEHLEN' ); ?></option>
...
function setImport_2Toolbar ($execute,$upload)
	{
		clm_core::$load->load_css("icons_images");
	ToolBarHelper::title(   Text::_( 'SWT_STEP2A' ), 'clm_headmenu_manager.png' );
	ToolBarHelper::custom('import_3','apply.png','apply_f2.png','SWT_STEP3',false);
	ToolBarHelper::custom('back','apply.png','apply_f2.png','SWT_BACK',false);
	}
...
function Import_2 (&$lists, &$swt, &$name_manuell, &$zps_db, &$vereine, &$sid, &$data, &$liga_swt, &$name_man_spl, $fileName, $sg_zps)
	...
	<fieldset>
	<legend><?php echo Text::_( 'SWT_TIPS' ); ?></legend>
	<?php echo Text::_( 'SWT_TIP_LINE11' ); ?>
	<br><?php echo Text::_( 'SWT_TIP_LINE12' ); ?>
	<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo Text::_( 'SWT_TIP_LINE12A' ); ?>
	<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo Text::_( 'SWT_TIP_LINE12B' ); ?>
	<br><?php echo Text::_( 'SWT_TIP_LINE13' ); ?><img width="16" height="16" src="images/cancel_f2.png" /><?php echo Text::_( 'SWT_TIP_LINE13A' ); ?>
	<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo Text::_( 'SWT_TIP_LINE13B' ); ?>
	<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo Text::_( 'SWT_TIP_LINE13C' ); ?>
	<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo Text::_( 'SWT_TIP_LINE13D' ); ?>
	<br><?php echo Text::_( 'SWT_TIP_LINE14' ); ?>
	</fieldset>
	</div>
	...
	<div class="col width-100">
	<fieldset>
	<legend><?php echo Text::_( 'SWT_MANNSCHAFT' ).' 1'; ?></legend>
	<table class="admintable">
	<tr>
		...
		<th class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_NAME' ); ?></th>
		<th width="3%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_TLNR' ); ?></th>
		<th width="2%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_G' ); ?></th>
		<th width="6%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_ZPS' ); ?></th>
		<th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_MGL' ); ?></th>
		<th width="20%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_VEREIN' ); ?></th>
		<th width="20%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_MAN_NAME' ); ?></th>
	...
	if($data[$y+1][1] > $data[$y][1]) { $zps_cnt ++;?>
		...
		<div class="col width-100">
		<fieldset>
		<legend><?php echo Text::_( 'SWT_MANNSCHAFT' ).' '; ?> <?php echo 1+$data[$y][1];?></legend>
			<table class="admintable">
			<tr>
				<th class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_NAME' ); ?></th>
				<th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_TLNR' ); ?></th>
				<th width="2%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_G' ); ?></th>
				<th width="6%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_ZPS' ); ?></th>
				<th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_MGL' ); ?></th>
				<th width="17%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_VEREIN' ); ?></th>
				<th width="17%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_MAN_NAME' ); ?></th>
			</tr>
	<?php }
	} ?>
...
function setImport_3Toolbar ($execute,$upload)
	{
		clm_core::$load->load_css("icons_images");
	ToolBarHelper::title(   Text::_( 'SWT_STEP3A' ), 'clm_headmenu_manager.png' );
	ToolBarHelper::custom('import_4','apply.png','apply_f2.png','SWT_STEP4',false);
	ToolBarHelper::custom('back','apply.png','apply_f2.png','SWT_BACK',false);
	}
...
function Import_3 (&$lists, &$swt, &$zps_db, &$sid, &$data, &$liga_swt, &$man_zps, $fileName, $sg_zps)
	...
	<fieldset>
	<legend><?php echo Text::_( 'SWT_TIPS' ); ?></legend>
	<?php echo Text::_( 'SWT_TIP_LINE21' ); ?>
	<br>&nbsp;&nbsp;&nbsp;<?php echo Text::_( 'SWT_TIP_LINE21A' ); ?>
	<br><br><?php echo Text::_( 'SWT_TIP_LINE22' ); ?>
	<br><br><?php echo Text::_( 'SWT_TIP_LINE23' ); ?>
	<b><?php echo Text::_( 'SWT_TIP_LINE23A' ); ?></b>
	<br><br><?php echo Text::_( 'SWT_TIP_LINE24'); ?>
	<br><br><?php echo Text::_( 'SWT_TIP_LINE25' ); ?>
	</fieldset>
	</div>

	<div class="width-60 fltrt">
	<fieldset>
	<legend><?php echo Text::_( 'SWT_AUT_NACHM' ); ?></legend>

	<table class="admintable">
	<tr>
		<th width="8%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_TLNR' ); ?></th>
		<th width="8%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_MGL_NR' ); ?></th>
		<th width="8%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_ZPS' ); ?></th>
		<th class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_NAME' ); ?></th>
		<th width="2%" class="key" nowrap="nowrap">#</th>
		<th width="50%" class="key" nowrap="nowrap"><?php echo Text::_( 'SWT_ADVICE' ); ?></th>
	</tr>
	...
	<?php } else { ?>
		<br><h1><?php echo Text::_( 'SWT_TIP_LINE31' ); ?></h1> 
		<h2><?php echo Text::_( 'SWT_TIP_LINE32' ); ?></h2>
	<?php } ?>
	<input type="hidden" name="liga_swt" value="<?php echo $liga_swt;?>" />
...
function setSWTToolbar($execute,$upload)
	{
		clm_core::$load->load_css("icons_images");
	ToolBarHelper::title(   Text::_( 'TITLE_SWT' ), 'clm_headmenu_manager.png' );	
	
	$clmAccess = clm_core::$access;
	if ( $execute == 1 AND $clmAccess->access('BE_swt_general') ) {
		ToolBarHelper::custom('import_1','apply.png','apply_f2.png','SWT_DATEI_IMPORT',false);
		ToolBarHelper::custom('swt_dat_del','delete.png','apply_f2.png','SWT_DATEN_DEL',false);
		ToolBarHelper::custom('swt_dat_nach','delete.png','apply_f2.png','SWT_NACHM_DEL',false);
	}
	if ( $upload == 1 AND $clmAccess->access('BE_swt_general') ) {
		ToolBarHelper::custom('upload_jfile','upload.png','send_f2.png','SWT_DATEI_LOAD',false);
	}
...
<div class="width-50 fltlft">
	<fieldset>
	<legend><?php echo Text::_( 'SWT_TIP_LINE40' ); ?></legend>
	<!---
	<font color="#ff0000"><b><?php echo Text::_( 'SWT_TIP_LINE41' ); ?></b></font><br>
	--->
	<?php echo Text::_( 'SWT_TIP_LINE42' ); ?><br><?php echo Text::_( 'SWT_TIP_LINE43' ); ?>
	</fieldset>

<form action="index.php" name="adminForm" id="adminForm" method="post" enctype="multipart/form-data" >
	<fieldset>
	<legend><?php echo Text::_( 'SWT_TIP_LINE50' ); ?></legend>
	<b><?php echo Text::_( 'SWT_TIP_LINE51' ).' '; ?> <?php if ($upload == 1) { ?><font color="#00ff00"><?php echo Text::_( 'SWT_ACTIVE' ); } 
				 else { ?><font color="#ff0000"><?php echo Text::_( 'SWT_DEACTIVE' ); } ?></font>
	
	<?php echo " , ".Text::_( 'SWT_TIP_LINE52' ).' '; ?><?php if ($execute == 1) { ?><font color="#00ff00"><?php echo Text::_( 'SWT_ACTIVE' ); } 
	else { ?><font color="#ff0000"><?php echo Text::_( 'SWT_DEACTIVE' ); } ?></font></b>
	</fieldset>

	<fieldset>
	<legend><?php echo Text::_( 'SWT_TIPS' ); ?></legend>
	<b><font color="#ff0000"><?php echo Text::_( 'SWT_TIP_LINE40' ); ?></font><?php echo Text::_( 'SWT_TIP_LINE61' ); ?></b>
	<br><?php echo Text::_( 'SWT_TIP_LINE62' ); ?>
	<!---
	<br><?php echo Text::_( 'SWT_TIP_LINE63' ); ?>
	<br><b><?php echo Text::_( 'SWT_TIP_LINE64' ); ?></b>
	--->
	<br><br><b><?php echo Text::_( 'SWT_TIP_LINE65' ); ?></b>
	<?php echo Text::_( 'SWT_TIP_LINE66' ); ?>
	<br><br><?php echo Text::_( 'SWT_TIP_LINE67' ).' '; ?> <b><?php echo Text::_( 'SWT_TIP_LINE68' ); ?></b> <?php echo Text::_( 'SWT_TIP_LINE69' ); ?>
	<br>
	<br><b><?php echo Text::_( 'SWT_TIP_LINE70' ); ?></b>
	<br><?php echo Text::_( 'SWT_TIP_LINE71' ); ?>
	<br><?php echo Text::_( 'SWT_TIP_LINE72' ); ?>
	<br><?php echo Text::_( 'SWT_TIP_LINE73' ); ?>
	<br><?php echo Text::_( 'SWT_TIP_LINE74' ); ?>
	</fieldset>
</div>
...
<?php if ($execute == 1) { ?>
	...
	<fieldset>
	<legend><?php echo Text::_( 'SWT_TIP_LINE80' ); ?></legend>
	<table>
	<tr>
	<td class="key" nowrap="nowrap">
	  <select size="1" name="sql_datei">
		<option value="0"><?php echo Text::_( 'SWT_TIP_LINE81' ); ?></option>
		<?php for ($x=0; $x < count($datei); $x++) { ?>
		 <option value="<?php echo $datei[$x]; ?>"><?php echo $datei[$x]; ?></option> 
		<?php } ?>
	  </select>
	</td>
	<td>&nbsp;&nbsp;&nbsp;<b><?php echo Text::_( 'SWT_TIP_LINE82' ); ?></b></td>
	</tr>
<!--	<tr>
	<td class="key" nowrap="nowrap">
...
<?php } ?>
	...
	<fieldset>
	<legend><?php echo Text::_( 'SWT_TIP_LINE90' ); ?></legend>
	<table>
	<tr>
	<td class="key" nowrap="nowrap">
	  <select size="1" name="swt_delete">
		<option value="0"><?php echo Text::_( 'SWT_TIP_LINE91' ); ?></option>
		<?php for ($x=0; $x < count($data); $x++) { ?>
		 <option value="<?php echo $data[$x]->swt_id; ?>"><?php echo $data[$x]->Liga; ?></option> 
		<?php } ?>
	  </select>
	</td>
	<td>&nbsp;&nbsp;&nbsp;<b><?php echo Text::_( 'SWT_TIP_LINE92' ); ?></b>
	<br>&nbsp;&nbsp;&nbsp;<?php echo Text::_( 'SWT_TIP_LINE93' ); ?>
	<br>&nbsp;&nbsp;&nbsp;<?php echo Text::_( 'SWT_TIP_LINE94' ); ?></td>
	</tr>
	</table>
	</fieldset>
...
<?php if ($upload == 1) { ?>
		...
		<fieldset>
		<legend><?php echo Text::_( 'SWT_TIP_LINE100' ); ?></legend>
...
<form action="<?php echo URI::base(); ?>index.php?option=com_clm&amp;task=sql_db" id="execute" method="post" name="sql_execute">
	<fieldset>
	<legend><?php echo Text::_( 'SWT_TIP_LINE101' ); ?></legend>
