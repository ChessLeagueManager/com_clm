		...
		<tr>
			<td width="50%" style="vertical-align: top;">
				<fieldset class="adminform"> 
					...
					<?php echo Text::_( 'SWT_ATTENTION_TEXT' ); ?>
					<br><br>
				</fieldset>
				<fieldset class="adminform"> 
					<legend style="font-size:130%;line-height:100%;margin-bottom:10px;"><?php echo Text::_( 'SWT_ACTIVATION_TAB' ); ?></legend> 
						<?php echo Text::_( 'SWT_ACTIVATION_TEXT01' ).' '; ?> <?php if ($upload == 1) { ?><font color="#00ff00"><?php echo Text::_( 'SWT_ACTIVE' ); } 
						else { ?><font color="#ff0000"><?php echo Text::_( 'SWT_DEACTIVE' ); } ?></font>
						<?php echo " , ".Text::_( 'SWT_ACTIVATION_TEXT02' ).' '; ?><?php if ($execute == 1) { ?><font color="#00ff00"><?php echo Text::_( 'SWT_ACTIVE' ); } 
						else { ?><font color="#ff0000"><?php echo Text::_( 'SWT_DEACTIVE' ); } ?></font>
				...
				<fieldset class="adminform"> 
					...
					<?php echo Text::_( 'SWT_HINTS_TEXT01' ); ?>
					<?php echo Text::_( 'SWT_HINTS_TEXT02' ); ?>
				</fieldset>
			</td>
			<td width="50%" style="vertical-align: top;">
				<?php if ($upload == 1) { ?>
				<fieldset class="adminform"> 
					<legend style="font-size:130%;line-height:100%;margin-bottom:10px;"><?php echo Text::_( 'SWT_UPLOAD_TAB' ); ?></legend> 
					<table width="100%">
						<tr>
							<td width="50%"><input type="file" name="swt_datei" /></td>
							<td width="50%"><?php echo Text::_( 'SWT_UPLOAD_TEXT' ); ?></td>
						</tr>
					</table>
				</fieldset>
				<?php } ?>
				<?php if ($execute == 1) { ?>
				<fieldset class="adminform"> 
					<legend style="font-size:130%;line-height:100%;margin-bottom:10px;"><?php echo Text::_( 'SWT_EXECUTE_TAB' ); ?></legend> 
					<table width="100%">
						<tr>
							<td width="50%"><?php echo $this->lists['swt_files'] ?></td>
							<td width="50%"><?php echo Text::_( 'SWT_EXECUTE_TEXT' ); ?></td>
						</tr>
					</table>
				</fieldset>
				<?php } ?>
