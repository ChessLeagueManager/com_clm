    ...
    public function display($tpl = null)
    {
        ...
        for ($p = 1; $p <= $anz_paarungen; $p++) {
            ...
            for ($b = 1; $b <= $swt_db_data['anz_bretter']; $b++) {
                ...
                if (isset($swt_data[$p]['hbrett_'.$b])) {
                    $hspieler = $swt_data[$p]['hbrett_'.$b];
                } else {
                    $hspieler = 0;
                }
                ...
                if (isset($swt_data[$p]['gbrett_'.$b])) {
                    $gspieler = $swt_data[$p]['gbrett_'.$b];
                } else {
                    $gspieler = 0;
                }
                $gsplist = array();
