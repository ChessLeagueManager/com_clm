...
<form action="index.php" method="post" name="adminForm" id="adminForm">
		...
		<tr>
			<td width="75%">
				<?php if ($trial_and_error == 1) {
					echo Text::_( 'DECODE_ANZEIGEZEILEN' );				
				?>
				  <input type="text" name="filter_numberlines" id="filter_numberlines" value="<?php echo $this->param['numberlines']; ?>" size="4" maxlength="5" title="<?php echo Text::_( 'DECODE_HINT' ); ?>" onchange="document.adminForm.submit();">
				<?php } ?>
			</td>
			<td nowrap="nowrap" width="25%">
				<?php
					echo Text::_( 'DECODE_SELECTION' );
	...
	<thead>
		<tr>
			...
			<th width="100">
				<?php echo Text::_( 'DECODE_NICKNAME' ); ?>
			</th>
			<th width="200">
				<?php echo Text::_( 'DECODE_NAME' ); ?>
			</th>
			<th width="200">
				<?php echo Text::_( 'DECODE_CLUB' ); ?>
			</th>
			<th width="350">
				<?php echo Text::_( 'DECODE_SELECT' ); ?>
			</th>
		</tr>
	</thead>
	<tfoot>
	...
	<tbody>
			...
			foreach ($this->turplayers as $player) { 
			  ...
			  <tr>
				...
				<td>
				  <input type="text" name="nname<?php echo $i; ?>" id="nname<?php echo $i; ?>" value="<?php echo $nname;  ?>" size="50" maxlength="150" style="width:100%;" title="<?php echo Text::_( 'DECODE_HINT' ); ?>">
				</td><td>
				  <input type="text" name="verein<?php echo $i; ?>" id="verein<?php echo $i; ?>" value="<?php echo $verein;  ?>" size="50" maxlength="150" style="width:100%;" title="<?php echo Text::_( 'DECODE_HINT' ); ?>">
				</td>
				</td><td class="paramlist_value">
					<select id="tname<?php echo $i; ?>" name="tname<?php echo $i; ?>" class="inputbox" size="1" title="<?php echo Text::_( 'DECODE_HINT' ); ?>" style="width: 350px !important; min-width: 350px; max-width: 350px;">
