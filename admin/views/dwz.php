...
static function setDWZToolbar($countryversion)
	...
	ToolBarHelper::title(  Text::_( 'TITLE_MEMBER'),'clm_headmenu_mitglieder' );
	if($clmAccess->access('BE_club_edit_member') !== false) {
		ToolBarHelper::custom( 'spieler_delete', 'trash.png', 'trash_f2.png', Text::_( 'MEMBER_BUTTON_DEL'),false );
	}
	...
	Joomla.submitbutton = function (pressbutton) { 
		...
		if (pre_task.value == 'add') {
			...
			if (form.filter_vid.value == "0") {
				alert( "<?php echo Text::_( 'MEMBER_JS_1', true ); ?>" );
			} else if (form.filter_sid.value == "0") {
				alert( "<?php echo Text::_( 'MEMBER_JS_2', true ); ?>" );
			} else if (form.filter_gid.value == "0") {
				alert( "<?php echo Text::_( 'MEMBER_JS_3', true ); ?>" );
			} else {
				Joomla.submitform( pressbutton );
			}
		} else {
...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	...
	<table class="admintable">
		...
		<legend><?php echo Text::_( 'MEMBER_TABLE_DATA' ); ?></legend>
		<?php echo $lists['vid'];  ?>&nbsp;&nbsp;
		<?php if (isset($lists['mgl'])) echo $lists['mgl'];  ?>&nbsp;&nbsp;
		<?php $mainframe	= Factory::getApplication();
...
<!--		<select name="filter_sort" id="filter_sort" class="js-example-basic-single" size="1" onchange="document.adminForm.submit();"> -->
		...
		<option value="0"  <?php if ($filter_sort =="0") { ?>selected="selected"<?php } ?>><?php echo Text::_( 'MEMBER_DD_1');?></option>
		<option value="(0+Mgl_Nr) DESC" <?php if ($filter_sort =="(0+Mgl_Nr) DESC") { ?>selected="selected"<?php } ?>><?php echo Text::_( 'MEMBER_DD_2');?></option>
		<option value="(0+Mgl_Nr) ASC" <?php if ($filter_sort =="(0+Mgl_Nr) ASC") { ?>selected="selected"<?php } ?>><?php echo Text::_( 'MEMBER_DD_3');?></option>
		<option value="Spielername DESC" <?php if ($filter_sort =="Spielername DESC") { ?>selected="selected"<?php } ?>><?php echo Text::_( 'MEMBER_DD_4');?></option>
		<option value="Spielername ASC" <?php if ($filter_sort =="Spielername ASC") { ?>selected="selected"<?php } ?>><?php echo Text::_( 'MEMBER_DD_5');?></option>
		<option value="DWZ DESC" <?php if ($filter_sort =="DWZ DESC") { ?>selected="selected"<?php } ?>><?php echo Text::_( 'MEMBER_DD_6');?></option>
		<option value="DWZ ASC" <?php if ($filter_sort =="DWZ ASC") { ?>selected="selected"<?php } ?>><?php echo Text::_( 'MEMBER_DD_7');?></option>
		<option value="Geburtsjahr DESC" <?php if ($filter_sort =="Geburtsjahr DESC") { ?>selected="selected"<?php } ?>><?php echo Text::_( 'MEMBER_DD_8');?></option>
		<option value="Geburtsjahr ASC" <?php if ($filter_sort =="Geburtsjahr ASC") { ?>selected="selected"<?php } ?>><?php echo Text::_( 'MEMBER_DD_9');?></option>
		<option value="Geschlecht DESC, Spielername ASC" <?php if ($filter_sort =="Geschlecht DESC, Spielername ASC") { ?>selected="selected"<?php } ?>><?php echo Text::_( 'MEMBER_DD_10');?></option>
		<option value="Geschlecht ASC, Spielername ASC" <?php if ($filter_sort =="Geschlecht ASC, Spielername ASC") { ?>selected="selected"<?php } ?>><?php echo Text::_( 'MEMBER_DD_11');?></option>
		<option value="Status DESC, Spielername ASC" <?php if ($filter_sort =="Status DESC, Spielername ASC") { ?>selected="selected"<?php } ?>><?php echo Text::_( 'MEMBER_DD_12');?></option>
		<option value="Status ASC, Spielername ASC" <?php if ($filter_sort =="Status ASC, Spielername ASC") { ?>selected="selected"<?php } ?>><?php echo Text::_( 'MEMBER_DD_13');?></option>
		</select>
		</fieldset>
		</td>
		</tr>
...
<?php	 $filter_mgl	= $mainframe->getUserStateFromRequest( "$option.filter_mgl",'filter_mgl',0,'int' ); ?>
	...
	<fieldset class="adminform">
	<legend><?php echo Text::_( 'MEMBER_TABLE_1' ); ?></legend>
	<?php if ($filter_vid !="0") { ?>
	<table class="admintable">
		<tr>
			<th width="4%" class="key" nowrap="nowrap"><?php echo Text::_( 'MEMBER_TABLE_2' ); ?></th>
			<th width="20%" class="key" nowrap="nowrap"><?php echo Text::_( 'MEMBER_TABLE_3' ); ?></th>
			<?php if ($countryversion == "de") { ?>
				<th width="4%" class="key" nowrap="nowrap"><?php echo Text::_( 'MEMBER_TABLE_4' ); ?></th>
				<th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'MEMBER_TABLE_5' ); ?></th>
				<th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'MEMBER_TABLE_51' ); ?></th>
			<?php } else { ?>
				<th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'MEMBER_TABLE_5E' ); ?></th>
				<th width="5%" class="key" nowrap="nowrap"><?php echo Text::_( 'MEMBER_TABLE_51E' ); ?></th>
			<?php } ?>
			<th width="3%" class="key" nowrap="nowrap"><?php echo Text::_( 'St' ); ?></th>
			<th width="4%" class="key" nowrap="nowrap"><?php echo Text::_( 'MEMBER_TABLE_53' ); ?></th>
			<th width="3%" class="key" nowrap="nowrap"><?php echo Text::_( 'MEMBER_TABLE_54' ); ?></th>
		</tr>
	...
	<?php } else { echo Text::_( 'MEMBER_TABLE_6' ); } ?>
	</fieldset>
	</div>
	...
	<div>
	<fieldset class="adminform">
	<legend><?php echo Text::_( 'MEMBER_TABLE_7' ); ?></legend>
	<?php echo Text::_( 'MEMBER_TABLE_8' ); ?>
	...
	<div>
	<fieldset class="adminform">
	<legend><?php echo Text::_( 'MEMBER_TABLE_9' ); ?></legend>
	<?php if ($filter_vid !="0") { ?>
	<table class="admintable">
		<?php if (!isset($spieler[0]->Spielername)) $filter_mgl = 0; ?>
		<tr>
			<td class="key" width="20%" nowrap="nowrap">
			<label for="name"><?php echo Text::_( 'MEMBER_TABLE_10' ); ?></label>
			</td>
			<td>
			...
			<td><?php echo Text::_( 'MEMBER_TABLE_11' ); ?></td>
		</tr>
	  <?php if ($countryversion == "de") { ?>
		<tr>
			<td class="key" nowrap="nowrap">
			<label for="mglnr"><?php echo Text::_( 'MEMBER_TABLE_12' ); ?></label>
			</td>
			<td>
			...
			<td><?php echo Text::_( 'MEMBER_TABLE_13' ); ?></td>
		</tr>
		<tr>
			<td class="key" nowrap="nowrap">
			<label for="gesperrt"><?php echo Text::_( 'MELDELISTE_BLOCK' ); ?></label>
			</td>
			<td align="left">
			<input type="checkbox" name="gesperrt" id="gesperrt" value="1" <?php if ($spieler[0]->gesperrt =="1") { echo 'checked="checked"'; }?>>
			</td>
			<td><?php echo Text::_( '' ); ?></td>
		</tr>
		<tr>
			<td class="key" nowrap="nowrap">
			<label for="PKZ"><?php echo Text::_( 'MEMBER_TABLE_121' ); ?></label>
			</td>
			<td>
			...
			<td><?php echo Text::_( 'MEMBER_TABLE_131' ); ?></td>
		</tr>
		<tr>
			<td class="key" nowrap="nowrap">
			<label for="dwz"><?php echo Text::_( 'MEMBER_TABLE_14' ); ?></label>
			</td>
			<td>
			...
			<td><?php echo Text::_( 'MEMBER_TABLE_15' ); ?></td>
		</tr>
		<tr>
			<td class="key" nowrap="nowrap">
			<label for="dwz_index"><?php echo Text::_( 'MEMBER_TABLE_16' ); ?></label>
			</td>
			<td>
			...
			<td><?php echo Text::_( 'MEMBER_TABLE_17' ); ?></td>
		</tr>
	  <?php } else { ?>
		<tr>
			<td class="key" nowrap="nowrap">
			<label for="mglnr"><?php echo Text::_( 'MEMBER_TABLE_12E' ); ?></label>
			</td>
			<td>
			<input class="inputbox" type="text" name="mglnr" id="mglnr" size="7" maxlength="7" <?php if (isset($filter_mgl) AND $filter_mgl !="0") {?> value="<?php echo $spieler[0]->Mgl_Nr ?>"<?php }?>/>
			</td>
			<td><?php echo Text::_( 'MEMBER_TABLE_13E' ); ?></td>
		</tr>
		<tr>
			<td class="key" nowrap="nowrap">
			<label for="PKZ"><?php echo Text::_( 'MEMBER_TABLE_121E' ); ?></label>
			</td>
			<td>
			<input class="inputbox" type="text" name="PKZ" id="PKZ" size="10" maxlength="10" <?php if (isset($filter_mgl) AND $filter_mgl !="0") {?> value="<?php echo $spieler[0]->PKZ ?>"<?php }?>/>
			</td>
			<td><?php echo Text::_( 'MEMBER_TABLE_131E' ); ?></td>
		</tr>
		<tr>
			<td class="key" nowrap="nowrap">
			<label for="dwz"><?php echo Text::_( 'MEMBER_TABLE_14E' ); ?></label>
			</td>
			<td>
			<input class="inputbox" type="text" name="dwz" id="dwz" size="7" maxlength="4" <?php if (isset($filter_mgl) AND $filter_mgl !="0") {?> value="<?php echo $spieler[0]->DWZ ?>"<?php }?>/>
			</td>
			<td><?php echo Text::_( 'MEMBER_TABLE_15E' ); ?></td>
		</tr>
	  <?php } ?>
		<tr>
			<td class="key" nowrap="nowrap">
			<label for="FIDE_Elo"><?php echo Text::_( 'Elo' ); ?></label>
			</td>
			<td>
			...
			<td><?php echo Text::_( 'Bspl. 1355' ); ?></td>
		</tr>
		<tr>
			<td class="key" nowrap="nowrap">
		...
		<tr>
			<td class="key" nowrap="nowrap">
			<label for="FIDE_Titel"><?php echo Text::_( 'Fide-Titel' ); ?></label>
			</td>
			<td>
			...
			<td><?php echo Text::_( 'Bspl. IM' ); ?></td>
		</tr>
		<tr>
			<td class="key" nowrap="nowrap">
			<label for="FIDE_Land"><?php echo Text::_( 'Fide-Föderation' ); ?></label>
			</td>
			<td>
			...
			<td><?php echo Text::_( 'Bspl. GER' ); ?></td>
		</tr>
		<tr>
			<td class="key" nowrap="nowrap">
			<label for="geschlecht"><?php echo Text::_( 'MEMBER_TABLE_18' ); ?></label>
			</td>
			<td>
<!--				<select class="js-example-basic-single" size="1" name="geschlecht" id="geschlecht"> -->
				...
				<option value="0" <?php if (isset($filter_mgl) AND $spieler[0]->Geschlecht !="M" AND $spieler[0]->Geschlecht !="W"){ ?> selected="selected"<?php } ?>><?php echo Text::_( 'MEMBER_TABLE_19' ); ?></option>
				<option value="M" <?php if (isset($filter_mgl) AND $spieler[0]->Geschlecht =="M"){ ?> selected="selected"<?php } ?>><?php echo Text::_( 'MEMBER_TABLE_20' ); ?></option> 
				<option value="W" <?php if (isset($filter_mgl) AND $spieler[0]->Geschlecht =="W"){ ?> selected="selected"<?php } ?>><?php echo Text::_( 'MEMBER_TABLE_21' ); ?></option> 
			</td>
			<td>Bspl. W</td>
		</tr>
		<tr>
			<td class="key" nowrap="nowrap">
			<label for="geburtsjahr"><?php echo Text::_( 'MEMBER_TABLE_22' ); ?></label>
			</td>
			<td>
		...
		<tr>
			...
			<td><?php echo Text::_( 'MEMBER_TABLE_33' ); ?></td>
		</tr>
		<tr>
			<td class="key" nowrap="nowrap" title="<?php echo Text::_( 'MEMBER_TABLE_JOIN_HINT' ); ?>">
			<label for="joiningdate"><?php echo Text::_( 'MEMBER_TABLE_JOIN' ); ?></label>
			</td>
			<td>
			...
			<td><?php echo Text::_( 'MEMBER_TABLE_JOIN_BEM' ); ?></td>
		</tr>
		<tr>
			<td class="key" nowrap="nowrap" title="<?php echo Text::_( 'MEMBER_TABLE_LEAVE_HINT' ); ?>">
			<label for="leavingdate"><?php echo Text::_( 'MEMBER_TABLE_LEAVE' ); ?></label>
			</td>
			<td>
			...
			<td><?php echo Text::_( 'MEMBER_TABLE_LEAVE_BEM' ); ?></td>
		</tr>
		<tr>
			<td colspan="2"><?php echo Text::_( 'MEMBER_TABLE_24' ); ?></td>
			<td><?php echo Text::_( 'MEMBER_TABLE_25' ); ?></td>
		</tr>

	</table>
	<?php } else { echo Text::_( 'MEMBER_TABLE_26' ); } ?>
	</fieldset>
	</div>
	...
	<br>
	<fieldset class="adminform">
	<legend style="margin-bottom:0"><?php echo Text::_( 'MEMBER_TABLE_27' ); ?></legend>
	<?php if ($filter_vid !="0") { ?>
		<table class="admintable">
			<tr>
				<td class="key" nowrap="nowrap">
<!--	  			<select class="js-example-basic-single" style="width:300px" size="1" name="spieler" id="spieler"> -->
	...
	<?php } else { echo Text::_( 'MEMBER_TABLE_29' ); } ?>
	</fieldset>
	</div>
...
<?php if($clmAccess->access('BE_club_edit_member') === true) { ?>
	...
	<br>
	<fieldset class="adminform">
	<legend style="margin-bottom:0"><?php echo Text::_( 'MEMBER_TABLE_30' ); ?></legend>
	<?php if ($filter_vid !="0") { ?>
		<table class="admintable">
			<tr>
				<td class="key" nowrap="nowrap">
...
<?php if($clmAccess->access('BE_database_general') === true AND $countryversion == "en") { ?>
	...
	<br>
	<fieldset class="adminform">
	<legend style="margin-bottom:0"><?php echo Text::_( 'MEMBER_TABLE_MOVE_0' ); ?></legend>
	<?php if ($filter_vid !="0") { ?>
		<table class="admintable">
			<tr>
				<td class="key" nowrap="nowrap">
<!--	  			<select class="js-example-basic-single" size="1" name="spieler_to" id="spieler_to"> -->
				...
				<td><?php echo Text::_( 'MEMBER_TABLE_MOVE_TO' ); ?></td>
...
<?php if($clmAccess->access('BE_database_general') === true AND $countryversion == "en") { ?>
	...
	<br>
	<fieldset class="adminform">
	<legend style="margin-bottom:0"><?php echo Text::_( 'MEMBER_TABLE_MOVE_1' ); ?></legend>
<!---	<?php if ($filter_vid_from !="0") { ?>  -->
		<table class="admintable">
			<tr>
				<td><?php echo Text::_( 'MEMBER_TABLE_MOVE_FROM' ); ?></td>
