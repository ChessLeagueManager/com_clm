						...
						<tr>
							<td width="40%">
								<select name="mturnier" id="mturnier" value="0" size="1">
									<option value="0" <?php if ($mturnier != 1) {
									    echo 'selected="selected"';
									} ?>><?php echo JText::_('SWT_MODE_LEAGUE');?></option>
									<option value="1" <?php if ($mturnier == 1) {
									    echo 'selected="selected"';
									} ?>><?php echo JText::_('SWT_MODE_MTURN');?></option>
								</select>
							</td>
						...
						<tr>
							<td width="40%">
								<select name="noOrgReference" id="noOrgReference" value="0" size="1">
									<option value="0" <?php if ($noOrgReference == '0') {
									    echo 'selected="selected"';
									} ?>><?php echo JText::_('SWT_NOORGREFERENCE_0');?></option>
									<option value="1" <?php if ($noOrgReference == '1') {
									    echo 'selected="selected"';
									} ?>><?php echo JText::_('SWT_NOORGREFERENCE_1');?></option>
								</select>
							</td>
						...
						<tr>
							<td width="40%">
								<select name="noBoardResults" id="noBoardResults" value="0" size="1">
									<option value="0" <?php if ($noBoardResults == '0') {
									    echo 'selected="selected"';
									} ?>><?php echo JText::_('SWT_NOBOARDRESULTS_0');?></option>
									<option value="1" <?php if ($noBoardResults == '1') {
									    echo 'selected="selected"';
									} ?>><?php echo JText::_('SWT_NOBOARDRESULTS_1');?></option>
								</select>
							</td>
