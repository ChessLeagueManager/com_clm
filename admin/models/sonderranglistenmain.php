...
{
    public $_sonderranglisten;
    public $_turniere;
    public $_total = null;
    public $_pagination = null;
    public $_user;
    public $_filterSaisons;
    public $_filterTurniere;
    ...
    public function getSonderranglisten()
    {
    ...
    public function getFilterSaisons()
    {
    ...
    public function getFilterTurniere()
    {
