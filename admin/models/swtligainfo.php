...
class CLMModelSWTLigainfo extends JModelLegacy
{
    ...
    public function getDataSWT()
    {
        ...
        if ($swt_data['tiebr1'] == 1 and $anzStreichwertungen == 1) {
            $swt_data['tiebr1'] = 11;
        }
        if ($swt_data['tiebr2'] == 1 and $anzStreichwertungen == 1) {
            $swt_data['tiebr2'] = 11;
        }
        ...
        //Ranglistenkorrektur
        if ($this->_SWTReadInt($swt, 675) == 0) {
            $swt_data['optionTiebreakersFideCorrect'] = false;
        } else {
            $swt_data['optionTiebreakersFideCorrect'] = true;
        }
    ...
    public function store()
    {
        ...
        if ($default_params['noOrgReference'] == '1') {
            $default_params['incl_to_season'] = '0';
        }
        $now_date = date('Y-m-d');
    ...
    public function _SWTReadName($file, $offset, $length)
    {
        $i = 0;
        $name = '';
    ...
    public function _SWTReadInt($file, $offset, $length = 1)
    {
        $value = 0;
        for ($i = 0; $i < $length; $i++) {
    ...
    public function _SWTReadBool($file, $offset)
    {
