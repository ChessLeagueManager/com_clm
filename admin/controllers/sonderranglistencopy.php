    ...
    public function _saveDo()
    {
        ...
        if (count($source) > 0) {
            ...
            for ($i = 0;$i < count($source);$i++) {
                if ($source[$i]->checked_out_time == '0000-00-00 00:00:00' or $source[$i]->checked_out_time == '1970-01-01 00:00:00') {
                    $source[$i]->checked_out_time = null;
                }
                if ($source[$i]->checked_out == 0) {
                    $source[$i]->checked_out = null;
                }
